...
CREATE TABLE `announcements` (
  ...
  `type` enum('general','maintenance','event','urgent','facility_update') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'general',
  `priority` enum('low','medium','high','urgent') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'medium',
  `target_audience` enum('all','citizens','admins') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all',
...
CREATE TABLE `bookings` (
  ...
  `city_of_residence` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'User city for resident discount',
  ...
  `special_discount_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'senior, pwd, student',
  `special_discount_id_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Uploaded ID for verification',
  ...
  `payment_tier` tinyint UNSIGNED DEFAULT NULL COMMENT 'Percentage citizen chose to pay upfront: 25, 50, 75, or 100',
  `down_payment_amount` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT 'Calculated down payment amount based on tier',
  `amount_paid` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT 'Total amount paid so far',
  `amount_remaining` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT 'Remaining balance to be paid',
  `payment_method` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'cash, gcash, paymaya, bank_transfer, credit_card',
  `down_payment_paid_at` datetime DEFAULT NULL COMMENT 'When the down payment was recorded/collected',
  `paymongo_checkout_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `paymongo_payment_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_recorded_by` bigint UNSIGNED DEFAULT NULL COMMENT 'Treasurer user_id who recorded the payment',
  `purpose` text COLLATE utf8mb4_unicode_ci COMMENT 'Event purpose/description',
  `expected_attendees` int DEFAULT NULL,
  `special_requests` text COLLATE utf8mb4_unicode_ci,
  `valid_id_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Type of ID uploaded (SSS, UMID, etc.)',
  `valid_id_front_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `valid_id_back_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `valid_id_selfie_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `supporting_doc_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Additional documents',
  `rejected_reason` text COLLATE utf8mb4_unicode_ci,
  `rejection_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'id_issue, facility_issue, document_issue, info_issue',
  `rejection_fields` json DEFAULT NULL COMMENT 'JSON array of specific fields that need to be corrected',
  ...
  `source_system` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'External system that created the booking',
  `external_reference_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Reference ID from external system',
  `staff_verified_by` bigint UNSIGNED DEFAULT NULL,
...
INSERT INTO `bookings` (`id`, `user_id`, `facility_id`, `start_time`, `end_time`, `base_rate`, `extension_rate`, `equipment_total`, `subtotal`, `city_of_residence`, `is_resident`, `resident_discount_rate`, `resident_discount_amount`, `special_discount_type`, `special_discount_id_path`, `special_discount_rate`, `special_discount_amount`, `total_discount`, `total_amount`, `payment_tier`, `down_payment_amount`, `amount_paid`, `amount_remaining`, `payment_method`, `down_payment_paid_at`, `paymongo_checkout_id`, `paymongo_payment_id`, `payment_recorded_by`, `purpose`, `expected_attendees`, `special_requests`, `valid_id_type`, `valid_id_front_path`, `valid_id_back_path`, `valid_id_selfie_path`, `supporting_doc_path`, `rejected_reason`, `rejection_type`, `rejection_fields`, `canceled_reason`, `canceled_at`, `user_name`, `applicant_name`, `applicant_email`, `applicant_phone`, `applicant_address`, `event_name`, `event_description`, `event_date`, `status`, `source_system`, `external_reference_id`, `staff_verified_by`, `staff_verified_at`, `staff_notes`, `admin_approved_by`, `admin_approved_at`, `admin_approval_notes`, `reserved_until`, `created_at`, `updated_at`, `expired_at`, `deleted_at`, `deleted_by`, `is_synced`, `last_synced_at`) VALUES
(3, 5, 12, '2025-12-27 08:00:00', '2025-12-27 13:00:00', 7000.00, 1000.00, 51200.00, 59200.00, 'Quezon City', 0, 0.00, 0.00, 'student', NULL, 20.00, 11840.00, 11840.00, 47360.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Sports Event', 50, NULL, 'School ID', 'bookings/valid_ids/front/UmDMG5ekiJcEu1Eta2lkytHpoMEw9WTdz8QeEMHO.jpg', 'bookings/valid_ids/back/tK1cSfRsOL1rfAdUBqvt20kWoHYPFEtnP8XDrlwI.jpg', 'bookings/valid_ids/selfie/1vFsLEbiy62EkCR7rHzwsCF1EDDjMXIDUO52JoIc.jpg', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2025-12-22 23:05:36', NULL, 2, '2025-12-20 21:43:13', NULL, NULL, '2025-12-18 23:07:59', '2025-12-27 21:19:26', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(4, 5, 11, '2026-01-02 08:00:00', '2026-01-02 13:00:00', 4050.00, 600.00, 0.00, 4650.00, 'Quezon City', 0, 0.00, 0.00, 'senior', NULL, 20.00, 930.00, 930.00, 3720.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Wedding Reception', 30, NULL, 'Senior Citizen ID', 'bookings/valid_ids/front/a6Jwc3Fz7ykmuODz9Rxd4YOIns0JW8kG4MXVDXau.jpg', 'bookings/valid_ids/back/06zURp2MmpZDgH0eKdPybtNClVxiscJJfr26liNj.jpg', 'bookings/valid_ids/selfie/VKWm1biv7mf9euvnIpTpT76YOGkr5fj87iSa2agp.jpg', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2025-12-25 01:36:50', NULL, 2, '2025-12-27 07:57:03', NULL, NULL, '2025-12-24 23:51:41', '2026-01-03 05:55:02', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(5, 5, 13, '2026-01-05 08:00:00', '2026-01-05 11:00:00', 7250.00, 0.00, 4000.00, 11250.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 11250.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Educational Workshop', 50, NULL, 'SSS ID', 'bookings/valid_ids/front/YZzhEExri5HZYddmAhkpWDm8Ufrp7Vk0aoNV9WI6.jpg', 'bookings/valid_ids/back/AMSUToKjpAHLdaQZhTrukakweKf5bGpHIbStDI2S.jpg', 'bookings/valid_ids/selfie/GPjJY8xnPvEnsfAn52Rx1l4NawG68j3Nbu0LzMS4.jpg', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2025-12-27 07:25:28', NULL, 2, '2025-12-27 07:56:44', NULL, NULL, '2025-12-27 07:24:32', '2026-02-03 15:14:48', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(6, 5, 13, '2026-01-05 13:00:00', '2026-01-05 18:00:00', 5075.00, 875.00, 10300.00, 16250.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 16250.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Charity Event', 35, NULL, 'PhilHealth ID', 'bookings/valid_ids/front/MHmQK4HZYkCY5mfmFr0h6WE7L7zYZdEZhmAdzxEE.jpg', 'bookings/valid_ids/back/KJPASj4DUJHkIusGGYPBDkj5EJiM9YUtdPRBA3tk.jpg', 'bookings/valid_ids/selfie/w3LnMkc2AIu8mpyEbNj3rGy79Q0UmvxaPB5Rp2ID.jpg', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2025-12-27 22:43:22', NULL, 2, '2025-12-29 09:39:30', NULL, NULL, '2025-12-27 22:42:19', '2026-02-03 15:14:50', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(7, 5, 11, '2026-01-05 08:00:00', '2026-01-05 13:00:00', 6750.00, 1000.00, 48050.00, 55800.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 55800.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Cultural Event', 50, 'Please arrange and prepare the equipment well.\r\n\r\nThank you!', 'Passport', 'bookings/valid_ids/front/RrR1HQcPYqwSuea3khwPElqvFzrmC9vna9uzI4wm.jpg', 'bookings/valid_ids/back/ZAyZsekJmpz05cuSWvILFZuf6wQldVzgP0CfxJWl.jpg', 'bookings/valid_ids/selfie/zUYcct6mmPu9zLbKc1cyvlAKVZmoPGMO0sLPyO8D.jpg', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2025-12-28 05:22:45', NULL, 2, '2025-12-28 06:02:37', NULL, NULL, '2025-12-28 04:24:57', '2026-02-03 15:14:50', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(8, 5, 14, '2026-01-06 08:00:00', '2026-01-06 11:00:00', 19500.00, 0.00, 44600.00, 64100.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 64100.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Boxing Match', 150, 'Let\'s Gooooo.', 'SSS ID', 'bookings/valid_ids/front/J0WLEYduNKIxmjuoBHhaXv9RzqjC4r4RWBnEiJvV.jpg', 'bookings/valid_ids/back/LKdUinnrggXhurC60rsCvhWXQIyLlqAsgvInazr4.jpg', 'bookings/valid_ids/selfie/EGMvrjajDi9cFEJOQ34guFRq3mPfJi2b0BZzVpBW.jpg', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2025-12-28 09:14:14', NULL, 2, '2025-12-29 23:20:50', NULL, NULL, '2025-12-28 08:31:14', '2026-02-03 15:14:50', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(9, 5, 14, '2026-01-06 13:00:00', '2026-01-06 16:00:00', 6500.00, 0.00, 0.00, 6500.00, 'Quezon City', 0, 0.00, 0.00, 'senior', NULL, 20.00, 1300.00, 1300.00, 5200.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Family Reunion', 50, NULL, 'Senior Citizen ID', 'bookings/valid_ids/front/r1yc7Sw63XRTNpGgTlW71VuJ1vU84CE5WYSMzV2k.jpg', 'bookings/valid_ids/back/fX6DlRG1Dtlk6IORagZcrZK4q4rthfjGcjIGiG0m.jpg', 'bookings/valid_ids/selfie/YzM5cT1r1jJn2ER1Y8L4pJife1Z07fEyZFocmRI7.jpg', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2025-12-28 09:14:59', NULL, 2, '2025-12-29 23:20:22', NULL, NULL, '2025-12-28 08:58:30', '2026-02-03 15:14:51', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(10, 5, 14, '2026-01-07 08:00:00', '2026-01-07 13:00:00', 3250.00, 500.00, 0.00, 3750.00, 'Quezon City', 0, 0.00, 0.00, 'student', NULL, 20.00, 750.00, 750.00, 3000.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Sports Event', 25, NULL, 'School ID', 'bookings/valid_ids/front/EqLx4aE87e7pW2ZfTFlhVKIvcIvf9fslBpgVtc6B.jpg', 'bookings/valid_ids/back/hhzQUZNn8bgghFMe6l92O9RwDXaDCAMnTWzscnLB.jpg', 'bookings/valid_ids/selfie/QVTEMKkJ4rav7KaoZ7GVIgP9R8KOtaf2kalUnCak.jpg', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'refunded', NULL, NULL, 3, '2025-12-29 23:15:25', NULL, 2, '2025-12-29 23:19:43', NULL, NULL, '2025-12-29 23:13:12', '2026-01-06 06:45:42', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(11, 5, 13, '2026-01-07 08:00:00', '2026-01-07 11:00:00', 5075.00, 0.00, 0.00, 5075.00, 'Quezon City', 0, 0.00, 0.00, 'senior', NULL, 20.00, 1015.00, 1015.00, 4060.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Company Seminar/Training', 35, NULL, 'Senior Citizen ID', 'bookings/valid_ids/front/wkHOe0Y3zUEfVXV6IVBKH9ROwAtEKztwA1Xlz83m.jpg', 'bookings/valid_ids/back/TG1auN7tohLSgBgaxIelqNowS4YpXDm5icwV4HKZ.jpg', 'bookings/valid_ids/selfie/8St6WNPsJSpx09P3Pwq9wjnfmcRYlHQhHjMYsn9o.jpg', NULL, 'Wrong id', NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'rejected', NULL, NULL, 3, '2025-12-31 21:26:12', NULL, NULL, NULL, NULL, NULL, '2025-12-29 23:28:35', '2025-12-31 21:26:12', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(12, 5, 11, '2026-01-09 08:00:00', '2026-01-09 11:00:00', 4050.00, 0.00, 0.00, 4050.00, 'Quezon City', 0, 0.00, 0.00, 'student', NULL, 20.00, 810.00, 810.00, 3240.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Birthday Celebration', 30, NULL, 'School ID', 'bookings/valid_ids/front/CF2hDaE5hVmfPBdZnQjeOnSCVTIzfhNej3HxIHPV.jpg', 'bookings/valid_ids/back/9AjymiqenuSvvhZ9BvJVtTexWRp37TZeq6tIltyY.jpg', 'bookings/valid_ids/selfie/HnNLOnDbEc1fYIDWbNAlB0cXgHXKWeGCN3tKOhLz.jpg', NULL, 'Wrong id', NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'rejected', NULL, NULL, 3, '2025-12-31 21:37:21', NULL, NULL, NULL, NULL, NULL, '2025-12-31 21:15:27', '2025-12-31 21:37:21', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(13, 5, 13, '2026-01-09 08:00:00', '2026-01-09 11:00:00', 5075.00, 0.00, 0.00, 5075.00, 'Quezon City', 0, 0.00, 0.00, 'pwd', NULL, 20.00, 1015.00, 1015.00, 4060.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Birthday Celebration', 35, NULL, 'PWD ID', 'bookings/valid_ids/front/dypRFSx4PSV5KeQ77fkltOWGa5lc6BUys0vM2yLg.jpg', 'bookings/valid_ids/back/GBbiRHeSBd9tsBTwhw49td6Ix7HVuV5OwHiUoYfx.jpg', 'bookings/valid_ids/selfie/7zYPWKFZBp4J2gbtueoAQRBrnyMuSkesluwQRQGB.jpg', NULL, 'Wrong date', NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'cancelled', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-12-31 21:40:01', '2025-12-31 21:40:28', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(14, 5, 14, '2026-01-09 08:00:00', '2026-01-09 11:00:00', 3250.00, 0.00, 0.00, 3250.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 3250.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Birthday Celebration', 25, NULL, 'SSS ID', 'bookings/valid_ids/front/2aw3x07JpXl6uHfEjoFykF85FG4u2A4AURFXLtlN.jpg', 'bookings/valid_ids/back/QFJP2od0xa6onYhUEy3JEF54eJXItyjrbHGoGUel.jpg', 'bookings/valid_ids/selfie/u9Pi3f4plWjUompYxI0UcG4hTTpD2lpjGKg8EcCR.jpg', NULL, 'Wrong date', NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'cancelled', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-12-31 21:46:14', '2025-12-31 21:46:45', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(15, 5, 11, '2026-01-15 08:00:00', '2026-01-15 11:00:00', 4050.00, 0.00, 2000.00, 6050.00, 'Quezon City', 0, 0.00, 0.00, 'pwd', NULL, 20.00, 1210.00, 1210.00, 4840.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Wala lang', 30, NULL, 'PWD ID', 'bookings/valid_ids/front/aqPFsFtbaabTMdC663eLmp83LgRmzLDi8QNa0PI3.jpg', 'bookings/valid_ids/back/dEHFY7maClbekAhZn9iTY2DRrGkPooHpIhesqjlI.jpg', 'bookings/valid_ids/selfie/nRQLGuwIEWa3Me0SCh4oSNc06lmdcTuxQy6CtVhH.jpg', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2026-01-07 03:20:35', NULL, 2, '2026-01-07 03:58:46', NULL, NULL, '2026-01-06 18:44:05', '2026-02-03 15:14:51', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(16, 5, 11, '2026-01-21 08:00:00', '2026-01-21 11:00:00', 4455.00, 0.00, 0.00, 4455.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 4455.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Wedding Reception', 33, NULL, 'SSS ID', 'bookings/valid_ids/front/il0YlzEUnwh6PkiiLOsno0V0CUQxhsNGo6prVKpI.png', 'bookings/valid_ids/back/1sHbvPEBs3VmzYTyHDHskdNCFle0pRZKm7Nb0tl2.png', 'bookings/valid_ids/selfie/zlZjzIfnOmSHZOJhWVrBYVONC6WbiqKKdTo5vQEF.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2026-01-13 03:03:05', NULL, 2, '2026-01-13 03:07:19', NULL, NULL, '2026-01-13 03:01:12', '2026-02-03 15:14:51', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(17, 5, 13, '2026-01-21 08:00:00', '2026-01-21 11:00:00', 5510.00, 0.00, 0.00, 5510.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 5510.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Birthday Celebration', 38, NULL, 'SSS ID', 'bookings/valid_ids/front/zqXzLjohE6pJA9N7UJJ1QHkQRJjU5smkD26PkjLx.png', 'bookings/valid_ids/back/VfLiSwHrdPQMetzzVyyhLZCptAOuJx5UdIv7Ho0M.png', 'bookings/valid_ids/selfie/AqwxuhD5EzkATtC6M1Hq7HJLzoFAOMs7z7msDIxX.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2026-01-13 03:14:41', NULL, 2, '2026-01-13 03:17:30', NULL, NULL, '2026-01-13 03:13:28', '2026-02-03 15:14:51', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(18, 5, 14, '2026-01-22 08:00:00', '2026-01-22 11:00:00', 3250.00, 0.00, 20000.00, 23250.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 23250.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Birthday Celebration', 25, NULL, 'SSS ID', 'bookings/valid_ids/front/KUAwCsDLjo77aUHuiZFrQTVqinok2SQVPkYOb7ib.png', 'bookings/valid_ids/back/tC2Rw7QhoEPorKsk7hLoV6Rp9HLikh6d3bsRPjO7.png', 'bookings/valid_ids/selfie/vE0aqXCyTL1spK1Qla5dYBYdxqQfe9saOEdjF6xU.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2026-01-13 19:19:26', NULL, 2, '2026-01-13 19:23:14', NULL, NULL, '2026-01-13 19:16:39', '2026-02-03 15:14:51', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(19, 5, 11, '2026-01-22 08:00:00', '2026-01-22 11:00:00', 4050.00, 0.00, 0.00, 4050.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 4050.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Birthday Celebration', 30, NULL, 'SSS ID', 'bookings/valid_ids/front/PrReX91J2PROVmlhzzWEMd4UzXoQsZ7UcMV8UCZI.png', 'bookings/valid_ids/back/NmqpAOAxmNG9g1ve9pkfAp9PIQkUDVwxPnVKk2UI.png', 'bookings/valid_ids/selfie/Q53paABKWVZIGpkLBDbuiPydHP52f6AF7ipegJJ3.png', NULL, NULL, NULL, NULL, 'Payment deadline exceeded', '2026-01-16 21:25:35', 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'canceled', NULL, NULL, 3, '2026-01-13 19:30:28', NULL, NULL, NULL, NULL, NULL, '2026-01-13 19:27:54', '2026-01-16 21:25:35', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(20, 5, 11, '2026-01-22 13:00:00', '2026-01-22 16:00:00', 4050.00, 0.00, 0.00, 4050.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 4050.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Birthday Celebration', 30, NULL, 'SSS ID', 'bookings/valid_ids/front/RChKnqwq4Eedg3fP4waGP3wE6Ow6bpKiWIrTLE5D.png', 'bookings/valid_ids/back/G2gurtZYQSdsCgofltf2NaEPlKBvS0QF2xjRrtxG.png', 'bookings/valid_ids/selfie/hkBCiraZFGzc6QW1JcumQKHG3leIkMdp2sOjMJDC.png', NULL, NULL, NULL, NULL, 'Payment deadline exceeded', '2026-01-16 21:25:35', 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'canceled', NULL, NULL, 3, '2026-01-13 19:34:12', NULL, NULL, NULL, NULL, NULL, '2026-01-13 19:33:15', '2026-01-16 21:25:35', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(21, 5, 11, '2026-01-22 18:00:00', '2026-01-22 21:00:00', 4050.00, 0.00, 0.00, 4050.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 4050.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Birthday Celebration', 30, NULL, 'SSS ID', 'bookings/valid_ids/front/EX74RHAog3aPaQ9vIYNe6QWFSGj9Hlfps7SZQPN8.png', 'bookings/valid_ids/back/8GZgFDuH0NB7Pd5c99w5mUDZnBxHUAUULsQbx4My.png', 'bookings/valid_ids/selfie/VERadGBxFnnZ5yrxr0iH36IEI4UFYnVAt4Ho6brB.png', NULL, NULL, NULL, NULL, 'Payment deadline exceeded', '2026-01-16 21:25:35', 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'canceled', NULL, NULL, 3, '2026-01-13 19:37:01', NULL, NULL, NULL, NULL, NULL, '2026-01-13 19:36:09', '2026-01-16 21:25:35', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(22, 5, 11, '2026-01-26 08:00:00', '2026-01-26 11:00:00', 4050.00, 0.00, 0.00, 4050.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 4050.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Birthday Celebration', 30, NULL, 'SSS ID', 'bookings/valid_ids/front/jpLjgTTINuGNQoLvOwq5u9wKMOC1JXlds91FXr5C.png', 'bookings/valid_ids/back/0przzM5OVAUM78cdm73ZckJAjc5ohxQBw413GhLf.png', 'bookings/valid_ids/selfie/NDbwuPt1E7MpDCFDqa6omHrYlyBhwkp3YctYUx1M.png', NULL, NULL, NULL, NULL, 'Payment deadline exceeded (auto-expired)', NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'expired', NULL, NULL, 3, '2026-01-16 21:10:50', NULL, NULL, NULL, NULL, NULL, '2026-01-16 20:40:21', '2026-02-11 16:00:03', '2026-02-11 16:00:03', NULL, NULL, 1, '2026-02-13 20:31:22'),
(23, 5, 13, '2026-01-26 08:00:00', '2026-01-26 11:00:00', 5075.00, 0.00, 0.00, 5075.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 5075.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Wedding Reception', 35, NULL, 'SSS ID', 'bookings/valid_ids/front/XYL6TtEvNdpn8f0XA4QWl5XTBImLZfH2nAefs62T.png', 'bookings/valid_ids/back/T2I3kCIBJKYu5Ud0izD4DPVa4m0fTKti0BdSHf5H.png', 'bookings/valid_ids/selfie/tXwadIXCAjAZyvLJnTzNpyHD2ang7a55BiUHUHak.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2026-01-16 21:59:38', NULL, NULL, NULL, NULL, NULL, '2026-01-16 20:49:43', '2026-02-03 15:14:51', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(24, 5, 14, '2026-01-26 08:00:00', '2026-01-26 11:00:00', 3250.00, 0.00, 0.00, 3250.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 3250.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Charity Event', 25, NULL, 'SSS ID', 'bookings/valid_ids/front/SOhZ0pOzjQJyX33be30jByU9aK2z7No4a5lNIGeY.png', 'bookings/valid_ids/back/Pc0cuCAQV5ODny5Wh6YrYn2sxWBU3IODN1XROoYY.png', 'bookings/valid_ids/selfie/wRPaBPaGRLGVlKOXAWuJoWvfq6IXc7zJW5349dzw.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2026-01-16 21:05:41', NULL, 2, '2026-01-16 21:15:50', NULL, NULL, '2026-01-16 21:03:00', '2026-02-03 15:14:51', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(25, 5, 12, '2026-02-05 08:00:00', '2026-02-05 11:00:00', 7000.00, 0.00, 0.00, 7000.00, 'Quezon City', 0, 0.00, 0.00, 'student', NULL, 20.00, 1400.00, 1400.00, 5600.00, NULL, 0.00, 0.00, 0.00, NULL, NULL, NULL, NULL, NULL, 'Birthday Celebration', 50, NULL, 'School ID', 'bookings/valid_ids/front/UW0BduhqczcTbKKyUCiGr3tKTXDKNbj3jS2Uruac.png', 'bookings/valid_ids/back/eqMbowRY361dGEAUVEtyHvzk91DtOAVryUQUVcH9.png', 'bookings/valid_ids/selfie/bSGGSSQUOYqBVecVBlrrfRW3jtwQxS73mdMGs7O0.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'completed', NULL, NULL, 3, '2026-01-28 09:01:01', NULL, NULL, NULL, NULL, NULL, '2026-01-28 08:59:55', '2026-02-11 15:15:03', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(27, 5, 13, '2026-02-19 08:00:00', '2026-02-19 11:00:00', 7250.00, 0.00, 0.00, 7250.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 7250.00, 100, 7250.00, 7250.00, 0.00, 'cashless', '2026-02-11 23:23:51', 'cs_2e257c7d3270dcfbf6e9208c', 'pay_scckcccsiMgKpVS6AHE2GpfV', NULL, 'wal lang', 50, NULL, 'School ID', 'bookings/valid_ids/front/anGB2CWcdAOwAFzl6BtfbhB0kaLyA29LJoafyXam.png', 'bookings/valid_ids/back/x02o6RRxFYt5WPWEpH6yS7jrZGsJO5SpE6PxnS23.png', 'bookings/valid_ids/selfie/W8ogpmz8jesmu3SKcpC0PHcYvzsH0hFoAVOdRyoD.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-11 15:22:44', '2026-02-11 15:23:51', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(28, 5, 14, '2026-02-25 08:00:00', '2026-02-25 11:00:00', 6500.00, 0.00, 0.00, 6500.00, 'Quezon City', 0, 0.00, 0.00, NULL, NULL, 0.00, 0.00, 0.00, 6500.00, 100, 6500.00, 6500.00, 0.00, 'cashless', '2026-02-12 00:14:49', 'cs_6d19fa0faf9e38e18f59cd8f', 'pay_sxg239yPZoc4UbV6Wf83KFQv', NULL, 'wala lang', 50, NULL, 'Company ID', 'bookings/valid_ids/front/Vh79LlJ9QIldMbQJ3FdeHrzQTnEi0MFuJO2KZb5h.png', 'bookings/valid_ids/back/ISKghKv3cXrfLFOaMveAmxVKjUmdGuEAVHZp2uG0.png', 'bookings/valid_ids/selfie/okIY6T94rbnXfg4bXlHFfDuoeQHOxH41CaCthsV2.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-11 16:14:01', '2026-02-11 16:14:49', NULL, NULL, NULL, 1, '2026-02-13 20:31:22'),
(29, 5, 12, '2026-02-20 08:00:00', '2026-02-20 11:00:00', 14000.00, 0.00, 0.00, 14000.00, 'Quezon City', 0, 0.00, 0.00, 'student', NULL, 20.00, 2800.00, 2800.00, 11200.00, 100, 11200.00, 11200.00, 0.00, 'cashless', '2026-02-12 00:58:40', 'cs_0b7c8de5d018b3460210852a', 'pay_aikJfZCACrunSus2QHJoSG9g', NULL, 'Government Program', 100, NULL, 'School ID', 'bookings/valid_ids/front/g1Ay3dfqUUUHe502BmPiMrLDa0j2Wx0HaHhgN3Vl.png', 'bookings/valid_ids/back/0kYMwQZ6T2UMDL6Z5R2qKI77grIETzA8wyt6ZB3Q.png', 'bookings/valid_ids/selfie/kMab4euMiCl4MRQHkmL24yatnj9f3gcurkXIrF6F.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Cristian Mark Angelo Llaneta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-11 16:57:53', '2026-02-11 16:58:40', NULL, NULL, NULL, 1, '2026-02-13 20:31:22');
...
CREATE TABLE `booking_conflicts` (
  ...
  `city_event_id` bigint UNSIGNED NOT NULL,
  `status` enum('pending','resolved') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `citizen_choice` enum('reschedule','refund','no_response') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `response_deadline` datetime NOT NULL,
  `responded_at` datetime DEFAULT NULL,
  `resolved_at` datetime DEFAULT NULL,
  `new_booking_id` bigint UNSIGNED DEFAULT NULL,
  `admin_notes` text COLLATE utf8mb4_unicode_ci,
  `refund_method` enum('cash','gcash','paymaya','bank_transfer') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `refund_account_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `refund_account_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `booking_equipment` (
  ...
  `quantity` int NOT NULL DEFAULT '1' COMMENT 'Number of units rented',
...
CREATE TABLE `budget_allocations` (
  ...
  `category` enum('maintenance','equipment','operations','staff','utilities','other') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `budget_expenditures` (
  ...
  `expenditure_type` enum('maintenance','equipment_purchase','operational_cost','staff_salary','utility_bill','other') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `citizen_program_registrations` (
  ...
  `registration_status` enum('registered','attended','cancelled','no_show') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'registered',
...
CREATE TABLE `city_events` (
  ...
  `event_description` text COLLATE utf8mb4_unicode_ci,
  `event_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'government',
  `created_by` bigint UNSIGNED NOT NULL,
...
CREATE TABLE `community_maintenance_requests` (
  `id` bigint UNSIGNED NOT NULL,
  `external_report_id` bigint UNSIGNED DEFAULT NULL,
  ...
  `report_type` enum('maintenance','complaint','suggestion','emergency') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'maintenance',
  `priority` enum('low','medium','high','urgent') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'medium',
...
CREATE TABLE `energy_reports_received` (
  ...
  `external_report_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `received_data` json NOT NULL COMMENT 'Full data from external system',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `equipment_items` (
  `id` bigint UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Equipment name (e.g., Monobloc Chair, Round Table)',
  `category` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'chairs, tables, sound_system, lighting, etc.',
  `description` text COLLATE utf8mb4_unicode_ci,
  `price_per_unit` decimal(10,2) NOT NULL COMMENT 'Rental price per unit',
  `quantity_available` int NOT NULL DEFAULT '0' COMMENT 'Total units available',
  `is_available` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'Can be rented',
  `image_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Photo of equipment',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(27, 'Upholstered Chairs', 'chairs', 'Padded upholstered chairs for more formal events.', 50.00, 100, 1, NULL, '2025-11-16 00:36:52', '2025-11-16 00:36:52', NULL),
...
CREATE TABLE `event_schedules_sent` (
  `id` bigint UNSIGNED NOT NULL,
  `booking_id` bigint UNSIGNED NOT NULL,
  `event_data` json NOT NULL COMMENT 'Event name, facility, attendees, date/time',
  `external_request_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('sent','acknowledged','failed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sent',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `external_projects` (
  `id` bigint UNSIGNED NOT NULL,
  `external_project_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `project_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contractor_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `project_start_date` date NOT NULL,
  `project_end_date` date NOT NULL,
  `affected_facilities` json NOT NULL COMMENT 'Array of facility IDs',
...
CREATE TABLE `facilities` (
  `facility_id` bigint UNSIGNED NOT NULL,
  `lgu_city_id` bigint UNSIGNED DEFAULT NULL,
  ...
  `image_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Facility photo',
...
CREATE TABLE `facility_reviews` (
  ...
  `admin_responder_id` bigint UNSIGNED DEFAULT NULL,
...
CREATE TABLE `government_program_bookings` (
  ...
  `equipment_provided` json DEFAULT NULL,
...
CREATE TABLE `infrastructure_project_requests` (
  `id` bigint UNSIGNED NOT NULL,
  `external_project_id` bigint UNSIGNED DEFAULT NULL COMMENT 'Project ID from Infrastructure PM system',
  `requesting_office` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `problem_identified` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `scope_item1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `scope_item2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `scope_item3` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `status` enum('draft','submitted','received','under_review','approved','rejected','in_progress','completed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'submitted',
...
CREATE TABLE `lgu_cities` (
  `id` bigint UNSIGNED NOT NULL,
  `city_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Caloocan, Quezon City, etc.',
  `city_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'CLCN, QC, etc.',
  `description` text COLLATE utf8mb4_unicode_ci,
  `status` enum('active','coming_soon','inactive') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `has_external_integration` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Integrated with their systems',
  `integration_config` json DEFAULT NULL COMMENT 'API URLs, keys, etc.',
  `facility_count` int NOT NULL DEFAULT '0' COMMENT 'Cached count of facilities',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `liquidation_items` (
  `id` bigint UNSIGNED NOT NULL,
  `government_program_booking_id` bigint UNSIGNED NOT NULL,
  `category` enum('refreshments','materials','transportation','miscellaneous') COLLATE utf8mb4_unicode_ci NOT NULL,
  `supplier_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `official_receipt_number` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `item_specification` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `maintenance_requests_sent` (
  ...
  `facility_id` bigint UNSIGNED NOT NULL,
  `booking_id` bigint UNSIGNED DEFAULT NULL,
  `request_data` json NOT NULL COMMENT 'Facility name, time, maintenance type',
  `external_request_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('sent','acknowledged','failed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sent',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `maintenance_schedules` (
  ...
  `maintenance_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'routine, repair, renovation, inspection',
  `description` text COLLATE utf8mb4_unicode_ci,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `is_recurring` tinyint(1) NOT NULL DEFAULT '0',
  `recurring_pattern` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'daily, weekly, monthly, yearly',
  `created_by` bigint UNSIGNED NOT NULL COMMENT 'Admin user ID who scheduled',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `maintenance_schedules_received` (
  `id` bigint UNSIGNED NOT NULL,
  `facility_id` bigint UNSIGNED NOT NULL,
  `external_schedule_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `maintenance_start` datetime NOT NULL,
  `maintenance_end` datetime NOT NULL,
  `maintenance_team` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(6, '2026_02_07_170000_create_refund_requests_table', 6);
...
CREATE TABLE `payment_slips` (
  ...
  `status` enum('unpaid','paid','expired') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unpaid',
  `payment_method` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_gateway` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'gcash, paymaya, bank, cash',
  `gateway_transaction_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Transaction ID from payment gateway',
  `gateway_reference_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `paymongo_checkout_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_receipt_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'URL to payment receipt',
  `gateway_webhook_payload` json DEFAULT NULL COMMENT 'Full webhook data from gateway',
  `treasurer_reference` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Reference number from Treasurer system',
  `or_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Official Receipt number',
  `treasurer_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'confirmed, pending, rejected from Treasurer',
  ...
  `treasurer_cashier_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `treasurer_cashier_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_intent_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_source_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_source_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'PS-2025-000001', 4, 3720.00, '2025-12-27 01:36:50', 'paid', 'cash', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OR-2025-0001', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-12-25 10:47:55', 7, 'OR-2025-0001', 0, NULL, NULL, NULL, NULL, '2025-12-25 02:37:09', '2025-12-25 10:47:55', 1, '2026-02-13 20:31:25'),
(2, 'PS-2025-000002', 5, 11250.00, '2025-12-29 07:25:28', 'paid', 'cash', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OR-2025-0002', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-12-27 07:36:15', 7, 'OR-2025-0002', 0, NULL, NULL, NULL, NULL, '2025-12-27 07:25:28', '2025-12-27 07:36:15', 1, '2026-02-13 20:31:25'),
...
(4, 'PS-2025-000004', 7, 55800.00, '2025-12-30 05:08:10', 'paid', 'cash', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OR-2025-0004', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-12-28 06:01:02', 7, NULL, 0, NULL, NULL, NULL, 'All goods', '2025-12-28 05:08:10', '2025-12-28 06:01:02', 1, '2026-02-13 20:31:25'),
(6, 'PS-2025-000005', 8, 64100.00, '2025-12-30 09:14:14', 'paid', 'cash', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OR-2025-0005', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-12-28 10:08:40', 7, NULL, 0, NULL, NULL, NULL, NULL, '2025-12-28 09:14:14', '2025-12-28 10:08:40', 1, '2026-02-13 20:31:25'),
...
(8, 'PS-2025-000007', 10, 3000.00, '2025-12-31 23:15:25', 'paid', 'cash', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OR-2025-0007', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-12-29 23:17:52', 7, NULL, 0, NULL, NULL, NULL, NULL, '2025-12-29 23:15:25', '2025-12-29 23:17:52', 1, '2026-02-13 20:31:25'),
(9, 'PS-2026-000001', 15, 4840.00, '2026-01-09 03:20:35', 'paid', 'cash', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OR-2026-0001', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-07 03:23:46', 7, NULL, 0, NULL, NULL, NULL, NULL, '2026-01-07 03:20:35', '2026-01-07 03:23:46', 1, '2026-02-13 20:31:25'),
(10, 'PS-2026-000002', 16, 4455.00, '2026-01-15 03:03:05', 'paid', 'cash', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OR-2026-0002', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-13 03:06:13', 7, NULL, 0, NULL, NULL, NULL, NULL, '2026-01-13 03:03:05', '2026-01-13 03:06:13', 1, '2026-02-13 20:31:25'),
(11, 'PS-2026-000003', 17, 5510.00, '2026-01-15 03:14:41', 'paid', 'cash', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OR-2026-0003', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-13 03:16:35', 7, NULL, 0, NULL, NULL, NULL, NULL, '2026-01-13 03:14:41', '2026-01-13 03:16:35', 1, '2026-02-13 20:31:25'),
(12, 'PS-2026-000004', 18, 23250.00, '2026-01-15 19:19:26', 'paid', 'cash', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OR-2026-0004', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-13 19:22:02', 7, NULL, 0, NULL, NULL, NULL, NULL, '2026-01-13 19:19:26', '2026-01-13 19:22:02', 1, '2026-02-13 20:31:25'),
(13, 'PS-2026-000005', 19, 4050.00, '2026-01-15 19:30:28', 'expired', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, '2026-01-13 19:30:28', '2026-01-16 21:25:35', 1, '2026-02-13 20:31:25'),
(14, 'PS-2026-000006', 20, 4050.00, '2026-01-15 19:34:12', 'expired', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, '2026-01-13 19:34:12', '2026-01-16 21:25:35', 1, '2026-02-13 20:31:25'),
(15, 'PS-2026-000007', 21, 4050.00, '2026-01-15 19:37:02', 'expired', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, '2026-01-13 19:37:02', '2026-01-16 21:25:35', 1, '2026-02-13 20:31:25'),
(16, 'PS-2026-000008', 24, 3250.00, '2026-01-18 21:05:42', 'paid', 'cash', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OR-2026-0005', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-16 21:14:47', 7, NULL, 0, NULL, NULL, NULL, NULL, '2026-01-16 21:05:42', '2026-01-16 21:14:47', 1, '2026-02-13 20:31:25'),
(17, 'PS-2026-000009', 22, 4050.00, '2026-01-18 21:10:51', 'expired', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, '2026-01-16 21:10:51', '2026-02-11 16:00:03', 1, '2026-02-13 20:31:25'),
(18, 'PS-2026-000010', 23, 5075.00, '2026-01-18 21:59:38', 'paid', 'gcash', NULL, NULL, 'pay_eUAaZgEAQgNMq8pxRM8XBXXA', 'cs_vbYbYJcJMKTe7vyCDgKZfLGA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-28 00:34:15', NULL, 'pay_eUAaZgEAQgNMq8pxRM8XBXXA', 0, 'paymongo', NULL, NULL, NULL, '2026-01-16 21:59:38', '2026-01-28 00:34:15', 1, '2026-02-13 20:31:25'),
(19, 'PS-2026-000011', 25, 5600.00, '2026-01-30 09:01:01', 'paid', 'gcash', NULL, NULL, 'pay_Vh4njvBP3n6Co1BJCCbr2nrD', 'cs_AJwCtY8R5QH1kVnsMbP7CAwL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-28 09:02:35', NULL, 'pay_Vh4njvBP3n6Co1BJCCbr2nrD', 0, 'paymongo', NULL, NULL, NULL, '2026-01-28 09:01:01', '2026-01-28 09:02:35', 1, '2026-02-13 20:31:25');
...
CREATE TABLE `refund_requests` (
  ...
  `refund_type` enum('admin_rejected','citizen_cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'admin_rejected',
  `reason` text COLLATE utf8mb4_unicode_ci,
  `refund_method` enum('cash','gcash','maya','bank_transfer') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('pending_method','pending_processing','processing','completed','failed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending_method',
  `processed_by` bigint UNSIGNED DEFAULT NULL,
  `processed_at` timestamp NULL DEFAULT NULL,
  `or_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `treasurer_notes` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `road_maintenance_received` (
  `id` bigint UNSIGNED NOT NULL,
  `external_maintenance_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `road_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `road_status` enum('open','closed','partial') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
  `closure_start` datetime DEFAULT NULL,
  `closure_end` datetime DEFAULT NULL,
  `alternative_routes` text COLLATE utf8mb4_unicode_ci,
  `traffic_advisory` text COLLATE utf8mb4_unicode_ci,
  `received_data` json NOT NULL COMMENT 'Full data from external system',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `suppliers` (
  ...
  `supplier_type` enum('food_service','printing','transportation','supplies','other') COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_person` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_phone` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_address` text COLLATE utf8mb4_unicode_ci,
  `business_permit_number` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tin_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bir_registration` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE `supplier_products` (
  ...
  `product_category` enum('meal','beverage','printing','material','service','other') COLLATE utf8mb4_unicode_ci NOT NULL,
  `specifications` json DEFAULT NULL,
  `unit_of_measure` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'piece',
  `current_price` decimal(10,2) NOT NULL,
  `price_effective_date` date NOT NULL,
  `is_available` tinyint(1) NOT NULL DEFAULT '1',
  `product_photo_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `price_list_document_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `usage_reports_sent` (
  ...
  `facility_id` bigint UNSIGNED NOT NULL,
  `booking_id` bigint UNSIGNED NOT NULL,
  `usage_data` json NOT NULL COMMENT 'Duration, attendees, equipment',
  `external_report_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('sent','acknowledged','failed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sent',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `is_synced` tinyint(1) DEFAULT '0'
...
--
-- Table structure for table `water_connection_requests`
--
...
CREATE TABLE `water_connection_requests` (
  ...
  `external_application_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `consumer_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `service_type` enum('water_connection','electricity_connection','water_reconnection','meter_replacement','transfer_service','disconnection') COLLATE utf8mb4_unicode_ci NOT NULL,
  `installation_address` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `property_type` enum('residential','commercial','industrial','government') COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_person` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_phone` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `partner_reference` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
...
ALTER TABLE `community_maintenance_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `community_maintenance_requests_external_report_id_index` (`external_report_id`),
  ADD KEY `community_maintenance_requests_facility_id_index` (`facility_id`),
  ADD KEY `community_maintenance_requests_resident_name_index` (`resident_name`),
  ADD KEY `community_maintenance_requests_status_index` (`status`),
...
--
-- Indexes for table `water_connection_requests`
--
ALTER TABLE `water_connection_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `water_connection_requests_user_id_index` (`user_id`),
  ADD KEY `water_connection_requests_external_application_number_index` (`external_application_number`),
  ADD KEY `water_connection_requests_status_index` (`status`),
  ADD KEY `water_connection_requests_service_type_index` (`service_type`);
...
--
ALTER TABLE `equipment_inventory`
  MODIFY `equipment_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `facilities`
  MODIFY `facility_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
-- AUTO_INCREMENT for table `water_connection_requests`
--
ALTER TABLE `water_connection_requests`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
