...
@section('page-subtitle', 'Find answers to your questions')
            ...
            <a href="{{ URL::signedRoute('citizen.help-center.article', $article->slug) }}" 
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600">{{ Str::limit($article->excerpt, 80) }}</p>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    <div class="p-4 hover:bg-gray-50">
                        <button type="button" onclick="toggleFaq({{ $faq->id }})" class="w-full text-left">
                            <div class="flex justify-between items-start">
                                <h4 class="font-semibold text-gray-800 pr-4">{{ $faq->question }}</h4>
                                <svg class="w-5 h-5 text-gray-400 flex-shrink-0 transform transition-transform" id="icon-{{ $faq->id }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                </svg>
                            </div>
                        </button>
                        <div id="faq-{{ $faq->id }}" class="hidden mt-3 text-gray-600">
                            <p>{{ $faq->answer }}</p>
