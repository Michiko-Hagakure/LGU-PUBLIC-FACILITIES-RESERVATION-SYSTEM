...
<div class="container mx-auto px-gr-md py-gr-lg">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-gr-lg mb-gr-lg">
        <form method="GET" action="{{ URL::signedRoute('staff.facilities.index') }}" class="space-y-gr-md">
            ...
            <div class="flex items-center gap-gr-sm">
                ...
                <a href="{{ URL::signedRoute('staff.facilities.index') }}" class="inline-flex items-center px-gr-md py-gr-sm bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 transition-colors duration-200">
        ...
        @forelse($facilities as $facility)
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
                ...
                <div class="p-gr-lg">
                    ...
                    <a href="{{ URL::signedRoute('staff.facilities.show', $facility->facility_id) }}" 
