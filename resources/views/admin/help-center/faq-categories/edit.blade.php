...
<div class="mb-6">
    <a href="{{ URL::signedRoute('admin.faq-categories.index') }}" class="text-blue-600 hover:text-blue-800 inline-flex items-center">
...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form action="{{ URL::signedRoute('admin.faq-categories.update', $category->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ URL::signedRoute('admin.faq-categories.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-6 py-2 rounded-lg transition duration-200">
                Cancel
            </a>
