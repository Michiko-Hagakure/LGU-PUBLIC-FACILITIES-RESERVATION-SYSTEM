...
<div class="container mx-auto px-gr-md py-gr-lg">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-gr-lg">
        <div class="flex">
            <a href="{{ URL::signedRoute('admin.facilities.index', request()->except(['show_deleted', 'signature', 'expires'])) }}" 
            ...
            <a href="{{ URL::signedRoute('admin.facilities.index', array_merge(request()->except(['show_deleted', 'signature', 'expires']), ['show_deleted' => '1'])) }}" 
