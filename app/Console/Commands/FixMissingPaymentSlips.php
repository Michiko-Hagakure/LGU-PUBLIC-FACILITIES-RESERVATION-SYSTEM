            ...
            if ($existingSlip) {
                ...
                DB::connection('facilities_db')
                    ...
                    ->insert([
                        ...
                        'paid_at' => null,
                        'notes' => 'Down payment (' . ($booking->payment_tier ?? '?') . '%) of ₱' . number_format($booking->amount_paid, 2) . ' collected at booking. Remaining balance to collect: ₱' . number_format($booking->amount_remaining, 2) . ' (auto-fix)',
                        'created_at' => $now,
                        'updated_at' => $now,
                    ]);
