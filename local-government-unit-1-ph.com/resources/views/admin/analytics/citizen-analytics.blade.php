    ...
    <div class="bg-white rounded-lg shadow-sm p-6 no-print">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-end gap-3">
                <form method="GET" action="{{ route('admin.analytics.citizen-analytics') }}" class="flex flex-wrap items-end gap-3">
                    <div>
                ...
                <a href="{{ route('admin.analytics.citizen-analytics.export', ['start_date' => $startDate, 'end_date' => $endDate]) }}" class="px-6 py-2 bg-lgu-headline text-white rounded-lg hover:bg-opacity-90 transition-all font-semibold">
