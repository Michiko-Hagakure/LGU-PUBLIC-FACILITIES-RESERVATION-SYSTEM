...
<?php $__env->startSection('title', 'Official Receipt Details'); ?>
<?php $__env->startSection('page-title', 'Official Receipt'); ?>
<?php $__env->startSection('page-subtitle', $paymentSlip->transaction_reference); ?>
...
<div id="receipt-print-area">
    <div style="max-width: 600px; margin: 0 auto; font-family: 'Poppins', sans-serif; color: #1f2937;">
        ...
        <div style="text-align: center; background: #f9fafb; padding: 20px; border-radius: 12px; margin-bottom: 30px;">
            ...
            <p style="font-size: 36px; font-weight: bold; color: #0f5b3a; margin: 0;">₱<?php echo e(number_format($paymentSlip->amount_due, 2)); ?></p>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 30px;">
            ...
            <div style="background: #f9fafb; padding: 15px; border-radius: 8px;">
                ...
                <p style="color: #1f2937; font-weight: 600; font-size: 14px; margin: 0;"><?php echo e($paymentSlip->transaction_reference); ?></p>
            </div>

            <!-- Payment Time -->
            <div style="background: #f9fafb; padding: 15px; border-radius: 8px;">
                <p style="color: #6b7280; font-size: 12px; margin: 0 0 5px 0;">Payment Time</p>
                <p style="color: #1f2937; font-weight: 600; font-size: 14px; margin: 0;"><?php echo e(\Carbon\Carbon::parse($paymentSlip->paid_at)->format('d M Y, H:i')); ?></p>
            </div>

            <!-- Payment Method -->
            <div style="background: #f9fafb; padding: 15px; border-radius: 8px;">
                <p style="color: #6b7280; font-size: 12px; margin: 0 0 5px 0;">Payment Method</p>
                <p style="color: #1f2937; font-weight: 600; font-size: 14px; margin: 0;"><?php echo e(ucfirst(str_replace('_', ' ', $paymentSlip->payment_method))); ?></p>
            </div>

            <!-- Payor Name -->
            <div style="background: #f9fafb; padding: 15px; border-radius: 8px;">
                <p style="color: #6b7280; font-size: 12px; margin: 0 0 5px 0;">Payor Name</p>
                <p style="color: #1f2937; font-weight: 600; font-size: 14px; margin: 0;"><?php echo e($paymentSlip->applicant_name); ?></p>
            </div>
        </div>
        ...
        <div style="background: #f9fafb; padding: 20px; border-radius: 8px; margin-bottom: 30px;">
            ...
            <p style="color: #1f2937; font-weight: 600; font-size: 14px; margin: 0 0 5px 0;"><?php echo e($paymentSlip->facility_name); ?></p>
            <p style="color: #6b7280; font-size: 12px; margin: 0;"><?php echo e(\Carbon\Carbon::parse($paymentSlip->start_time)->format('F d, Y')); ?> • <?php echo e(\Carbon\Carbon::parse($paymentSlip->start_time)->format('h:i A')); ?> - <?php echo e(\Carbon\Carbon::parse($paymentSlip->end_time)->format('h:i A')); ?></p>
        </div>
        ...
        <div style="text-align: center;">
            ...
            <p style="color: #9ca3af; font-size: 11px; margin: 10px 0 0 0;">Payment Slip: <?php echo e($paymentSlip->slip_number); ?></p>
        </div>
...
<!-- Back Button -->
<div class="mb-6">
    <a href="<?php echo e(route('treasurer.official-receipts')); ?>" 
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="mt-1 text-lg font-bold text-green-600"><?php echo e($paymentSlip->transaction_reference); ?></p>
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-500">Payment Slip #</label>
                    <p class="mt-1 text-base font-semibold text-lgu-button"><?php echo e($paymentSlip->slip_number); ?></p>
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-500">Date Issued</label>
                    <p class="mt-1 text-sm text-gray-900"><?php echo e(\Carbon\Carbon::parse($paymentSlip->paid_at)->format('F d, Y h:i A')); ?></p>
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-500">Payment Method</label>
                    <p class="mt-1 text-sm text-gray-900"><?php echo e(ucfirst(str_replace('_', ' ', $paymentSlip->payment_method))); ?></p>
                </div>
                
                <div class="col-span-2">
                    <label class="block text-sm font-medium text-gray-500">Amount Paid</label>
                    <p class="mt-1 text-3xl font-bold text-lgu-headline">₱<?php echo e(number_format($paymentSlip->amount_due, 2)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-900 font-semibold"><?php echo e($paymentSlip->facility_name); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e($paymentSlip->facility_address); ?></p>
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-500">Event Date</label>
                    <p class="mt-1 text-sm text-gray-900"><?php echo e(\Carbon\Carbon::parse($paymentSlip->start_time)->format('F d, Y')); ?></p>
                </div>
    ...
    <div class="lg:col-span-1 space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="space-y-3">
                <a href="<?php echo e(route('treasurer.official-receipts.print', $paymentSlip->id)); ?>" 
                ...
                <a href="<?php echo e(route('treasurer.payment-slips.show', $paymentSlip->id)); ?>" 
        ...
        <div class="bg-green-50 border-2 border-green-200 rounded-xl p-6">
            ...
            <?php if($paymentSlip->verified_by_name): ?>
            <div class="mt-4 pt-4 border-t border-green-200">
                <p class="text-xs text-green-700">Verified by:</p>
                <p class="text-sm font-semibold text-green-800"><?php echo e($paymentSlip->verified_by_name); ?></p>
            </div>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.treasurer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\local-government-unit-1-ph.com\resources\views/treasurer/official-receipts/show.blade.php ENDPATH**/ ?>