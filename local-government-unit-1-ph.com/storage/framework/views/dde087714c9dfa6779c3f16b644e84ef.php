...
<?php $__env->startSection('title', 'Revenue Report - Admin'); ?>
...
<div class="space-y-6 print-area">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 no-print">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-end gap-3">
                <form method="GET" action="<?php echo e(route('admin.analytics.revenue-report')); ?>" class="flex flex-wrap items-end gap-3">
                    <div>
    ...
    <div class="hidden print:block mb-6">
        <div class="text-center mb-4">
            ...
            <p class="text-sm text-gray-600 mt-1"><?php echo e(\Carbon\Carbon::parse($startDate)->format('F d, Y')); ?> - <?php echo e(\Carbon\Carbon::parse($endDate)->format('F d, Y')); ?></p>
            <p class="text-xs text-gray-500 mt-1">Generated on: <?php echo e(now()->format('F d, Y h:i A')); ?></p>
        </div>
    ...
    <div class="bg-lgu-headline rounded-lg shadow-lg p-8 border-2 border-lgu-highlight no-print">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-5xl font-bold text-white">₱<?php echo e(number_format($totalRevenue, 2)); ?></h3>
                <p class="text-white text-sm mt-2 font-medium"><?php echo e(\Carbon\Carbon::parse($startDate)->format('M d, Y')); ?> - <?php echo e(\Carbon\Carbon::parse($endDate)->format('M d, Y')); ?></p>
            </div>
    ...
    <div class="hidden print:block bg-white border-2 border-lgu-headline rounded-lg p-8 mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-5xl font-bold text-lgu-headline">₱<?php echo e(number_format($totalRevenue, 2)); ?></h3>
                <p class="text-sm mt-2 font-medium text-lgu-paragraph"><?php echo e(\Carbon\Carbon::parse($startDate)->format('M d, Y')); ?> - <?php echo e(\Carbon\Carbon::parse($endDate)->format('M d, Y')); ?></p>
            </div>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <div class="text-sm text-gray-600"><?php echo e($totalRevenue > 0 ? number_format(($facility->total_revenue / $totalRevenue) * 100, 1) : 0); ?>%</div>
                        </td>
                    </tr>
                ...
                <tfoot class="bg-gray-50">
                    <tr>
                        ...
                        <td class="px-6 py-4 text-right text-sm font-bold text-green-600">₱<?php echo e(number_format($totalRevenue, 2)); ?></td>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                ...
                <p class="text-2xl font-bold text-lgu-headline">₱<?php echo e(number_format($method->total_amount, 2)); ?></p>
...
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(function() {
        ...
        if (paymentContainer) {
            const paymentData = <?php echo json_encode($revenueByPaymentMethod, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\local-government-unit-1-ph.com\resources\views/admin/analytics/revenue-report.blade.php ENDPATH**/ ?>