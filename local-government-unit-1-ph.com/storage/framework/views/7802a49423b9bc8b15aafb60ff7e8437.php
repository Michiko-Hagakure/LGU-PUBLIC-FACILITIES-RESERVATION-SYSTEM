...
<?php $__env->startSection('page-subtitle', 'City Budget Department - Revenue & Financial Overview'); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <h3 class="text-2xl font-bold text-lgu-headline">₱<?php echo e(number_format($currentMonthRevenue, 2)); ?></h3>
            </div>
        ...
        <?php if($revenueGrowth > 0): ?>
            <p class="text-sm text-green-600">+<?php echo e(number_format($revenueGrowth, 1)); ?>% from last month</p>
        <?php elseif($revenueGrowth < 0): ?>
            <p class="text-sm text-red-600"><?php echo e(number_format($revenueGrowth, 1)); ?>% from last month</p>
        <?php else: ?>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <h3 class="text-2xl font-bold text-lgu-headline">₱<?php echo e(number_format($ytdRevenue, 2)); ?></h3>
            </div>
            <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                <i data-lucide="dollar-sign" class="w-6 h-6 text-green-600"></i>
            </div>
        </div>
        <p class="text-sm text-gray-500"><?php echo e(date('Y')); ?> Revenue</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <h3 class="text-2xl font-bold text-lgu-headline"><?php echo e(number_format($totalBookings)); ?></h3>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <h3 class="text-2xl font-bold text-lgu-headline"><?php echo e($activeFacilities); ?></h3>
            </div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($facility->name); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($facility->city); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e(number_format($facility->booking_count)); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-green-600">₱<?php echo e(number_format($facility->total_revenue, 2)); ?></td>
                </tr>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($payment->booking_reference); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($payment->user_name); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($payment->facility_name); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-green-600">₱<?php echo e(number_format($payment->amount_due, 2)); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e(\Carbon\Carbon::parse($payment->paid_at)->format('M d, Y')); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const monthlyData = <?php echo json_encode($monthlyTrend, 15, 512) ?>;
    ...
    const paymentMethodData = <?php echo json_encode($revenueByPaymentMethod, 15, 512) ?>;
...
<?php echo $__env->make('layouts.cbd', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\local-government-unit-1-ph.com\resources\views/cbd/dashboard.blade.php ENDPATH**/ ?>