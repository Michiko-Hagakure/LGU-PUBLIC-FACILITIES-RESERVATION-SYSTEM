...
<?php $__env->startSection('title', 'Booking Request Declined'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="info-box info-box-error">
        ...
        <p><strong>Requested Date:</strong> <?php echo new \Illuminate\Support\EncodedHtmlString(\Carbon\Carbon::parse($booking->start_time)->format('F d, Y - h:i A')); ?></p>
    ...
    <p style="text-align: center;">
        <a href="<?php echo new \Illuminate\Support\EncodedHtmlString(url('/citizen/facilities')); ?>" class="button">
...
<?php echo $__env->make('emails.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\local-government-unit-1-ph.com\resources\views/emails/booking-rejected.blade.php ENDPATH**/ ?>