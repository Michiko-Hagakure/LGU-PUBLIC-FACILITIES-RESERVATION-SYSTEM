...
<div x-data="registerForm(<?php echo e($step); ?>, <?php echo e($verificationEmailSent ? 'true' : 'false'); ?>)">
    ...
    <div class="google-signup-section mb-4">
        <a href="<?php echo e(route('auth.google.register')); ?>" class="btn btn-google w-100">
...
<style>
    ...
    .google-signup-section .divider::before,
    .google-signup-section .divider::after {
        content: '';
        flex: 1;
        border-bottom: 1px solid #e0e0e0;
    }
    
    .google-signup-section .divider span {
        padding: 0 1rem;
    }
