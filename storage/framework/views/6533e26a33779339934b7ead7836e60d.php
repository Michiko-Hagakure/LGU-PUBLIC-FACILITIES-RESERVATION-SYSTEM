...
<div class="p-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <form action="<?php echo e(route('staff.notifications.send')); ?>" method="POST" class="bg-white rounded-2xl shadow-lg p-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-6">
                    ...
                    <select id="templateSelect" class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-lgu-stroke focus:outline-none">
                        ...
                        <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $categoryTemplates): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <optgroup label="<?php echo e(ucfirst($category)); ?>">
                                <?php $__currentLoopData = $categoryTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($template->id); ?>" data-type="<?php echo e($template->type); ?>">
                                        <?php echo e($template->name); ?> (<?php echo e(strtoupper($template->type)); ?>)
                                    </option>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="mb-4 p-4 bg-gray-50 rounded-lg border-l-4 
                        <?php echo e($campaign->status === 'sent' ? 'border-green-500' : ''); ?>

                        <?php echo e($campaign->status === 'pending' ? 'border-yellow-500' : ''); ?>

                        <?php echo e($campaign->status === 'failed' ? 'border-red-500' : ''); ?>">
                        <div class="flex items-start justify-between mb-2">
                            <span class="px-2 py-1 text-xs font-semibold rounded 
                                <?php echo e($campaign->type === 'email' ? 'bg-blue-100 text-blue-800' : ''); ?>

                                <?php echo e($campaign->type === 'sms' ? 'bg-green-100 text-green-800' : ''); ?>

                                <?php echo e($campaign->type === 'in-app' ? 'bg-purple-100 text-purple-800' : ''); ?>">
                                <?php echo e(strtoupper($campaign->type)); ?>

                            </span>
                            <span class="text-xs text-gray-500">
                                <?php echo e(\Carbon\Carbon::parse($campaign->created_at)->diffForHumans()); ?>

                            </span>
                        </div>
                        <p class="text-sm font-semibold text-gray-700 mb-1"><?php echo e(Str::limit($campaign->subject ?? $campaign->message, 40)); ?></p>
                        <p class="text-xs text-gray-600">
                            <?php echo e($campaign->sent_count); ?> sent
                            <?php if($campaign->failed_count > 0): ?>
                                , <?php echo e($campaign->failed_count); ?> failed
                            <?php endif; ?>
                        </p>
                    </div>
...
<?php echo $__env->make('layouts.staff', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/staff/notifications/index.blade.php ENDPATH**/ ?>