...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Dear <?php echo e($citizen->full_name); ?>,</p>
            ...
            <div class="receipt-card">
                ...
                <div class="details">
                    <strong>OR Number:</strong> <?php echo e($transaction->or_number ?? 'OR-2026-0001'); ?><br>
                    <strong>Payment Slip:</strong> <?php echo e($transaction->slip_number); ?><br>
                    <strong>Amount Paid:</strong> ₱<?php echo e(number_format($transaction->amount_due, 2)); ?><br>
                    <strong>Payment Date:</strong> <?php echo e(\Carbon\Carbon::parse($transaction->paid_at)->format('F d, Y - h:i A')); ?>
...
</html><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/emails/receipt.blade.php ENDPATH**/ ?>