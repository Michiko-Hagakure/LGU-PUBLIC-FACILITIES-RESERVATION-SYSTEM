...
<?php $__env->startSection('title', 'Booking Statistics - Admin'); ?>
...
<div class="space-y-6 print-area">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 no-print">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-end gap-3">
                <form method="GET" action="<?php echo e(route('admin.analytics.booking-statistics')); ?>" class="flex flex-wrap items-end gap-3">
                    <div>
                ...
                <div class="relative inline-block" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-10">
                        <a href="<?php echo e(route('admin.analytics.export-booking-statistics-excel', ['start_date' => $startDate, 'end_date' => $endDate])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-lgu-bg">
                            <i data-lucide="file-spreadsheet" class="w-4 h-4 inline mr-2"></i>
                            Export as Excel
                        </a>
                        <a href="<?php echo e(route('admin.analytics.export-booking-statistics-pdf', ['start_date' => $startDate, 'end_date' => $endDate])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-lgu-bg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <p class="text-3xl font-bold text-lgu-headline"><?php echo e(number_format($totalBookings)); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <p class="text-3xl font-bold text-green-600"><?php echo e(number_format($paidBookings)); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <p class="text-3xl font-bold text-purple-600"><?php echo e(number_format($conversionRate, 1)); ?>%</p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <p class="text-3xl font-bold text-lgu-headline">₱<?php echo e(number_format($avgBookingValue, 2)); ?></p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = $peakHours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-gray-700 font-medium">
                            <?php echo e(sprintf('%02d:00', $hour->hour)); ?> - <?php echo e(sprintf('%02d:00', $hour->hour + 1)); ?>

                        </span>
                    </div>
                    <span class="text-gray-600"><?php echo e($hour->count); ?> bookings</span>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = $peakDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="p-2 bg-teal-500/10 rounded-lg">
                            <i data-lucide="calendar" class="w-4 h-4 text-teal-500"></i>
                        </div>
                        <span class="text-gray-700 font-medium"><?php echo e($day->day_name); ?></span>
                    </div>
                    <span class="text-gray-600"><?php echo e($day->count); ?> bookings</span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <p class="text-gray-500 text-center py-4">No data available</p>
                <?php endif; ?>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $popularFacilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <?php else: ?>
                                    <span class="inline-flex items-center justify-center w-8 h-8 bg-gray-50 text-gray-600 rounded-full font-medium"><?php echo e($index + 1); ?></span>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <div class="text-sm font-semibold text-lgu-headline"><?php echo e($facility->booking_count); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <div class="text-sm font-semibold text-green-600">₱<?php echo e(number_format($facility->total_revenue, 2)); ?></div>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
...
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(function() {
        ...
        if (statusContainer) {
            const statusData = <?php echo json_encode($bookingsByStatus, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/admin/analytics/booking-statistics.blade.php ENDPATH**/ ?>