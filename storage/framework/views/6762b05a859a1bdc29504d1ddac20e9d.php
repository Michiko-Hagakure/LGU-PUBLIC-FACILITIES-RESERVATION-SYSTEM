    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-3">
                <form method="POST" action="<?php echo e(route('admin.backup.clean')); ?>" class="inline" id="cleanBackupForm">
                    <?php echo csrf_field(); ?>
                    <button type="button" 
                ...
                <form method="POST" action="<?php echo e(route('admin.backup.create')); ?>" class="inline" id="createBackupForm">
                    <?php echo csrf_field(); ?>
                    <button type="button" 
        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <ul class="text-sm text-blue-800 space-y-1">
                    ...
                    <li><strong>Storage Location:</strong> <?php echo e(storage_path('app/' . config('backup.backup.name'))); ?></li>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 bg-lgu-header border-b-4 border-lgu-stroke">
            <h2 class="text-xl font-bold text-white flex items-center gap-2">
                ...
                Available Backups (<?php echo e(count($backups)); ?>)
            </h2>
        </div>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="font-mono text-sm text-gray-700"><?php echo e($backup['name']); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="text-sm text-gray-600 font-semibold"><?php echo e($backup['size']); ?></span>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="text-sm text-gray-600"><?php echo e($backup['date']); ?></span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex justify-center gap-2">
                                        <form method="POST" action="<?php echo e(route('admin.backup.download', $backup['name'])); ?>" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" 
                                        ...
                                        <form method="POST" action="<?php echo e(route('admin.backup.destroy', $backup['name'])); ?>" class="inline delete-backup-form">
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <button type="button" 
                                                    ...
                                                    onclick="confirmDeleteBackup(this, '<?php echo e($backup['name']); ?>')">
        ...
        <?php else: ?>
            <div class="px-6 py-12 text-center">
                ...
                <form method="POST" action="<?php echo e(route('admin.backup.create')); ?>" class="inline">
                    <?php echo csrf_field(); ?>
                    <button type="submit" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/admin/backup/index.blade.php ENDPATH**/ ?>