...
<?php $__env->startSection('title', 'Monthly Summary Report'); ?>
<?php $__env->startSection('page-title', 'Monthly Summary Report'); ?>
...
<div class="space-y-gr-lg">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="GET" action="<?php echo e(route('treasurer.reports.monthly-summary')); ?>" class="flex flex-col md:flex-row items-end gap-4">
            <div class="flex-1">
            ...
            <a href="<?php echo e(route('treasurer.reports.monthly-summary.export', ['month' => $selectedMonth->format('Y-m')])); ?>" 
    ...
    <div class="text-center">
        <h2 class="text-h3 font-bold text-lgu-headline"><?php echo e($selectedMonth->format('F Y')); ?></h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gr-md">
        ...
        <div class="bg-green-500 rounded-xl shadow-lg p-6 text-white">
            ...
            <p class="text-2xl font-bold">₱<?php echo e(number_format($stats['total_revenue'], 2)); ?></p>
        </div>
        ...
        <div class="bg-purple-500 rounded-xl shadow-lg p-6 text-white">
            ...
            <p class="text-2xl font-bold">₱<?php echo e(number_format($stats['average_transaction'], 2)); ?></p>
        </div>
        ...
        <div class="bg-orange-500 rounded-xl shadow-lg p-6 text-white">
            ...
            <p class="text-2xl font-bold"><?php echo e($stats['days_with_collections']); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-gr-sm">
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <p class="text-xl font-bold text-green-900">₱<?php echo e(number_format($methodBreakdown['cash']['amount'], 2)); ?></p>
                <p class="text-caption text-green-700 mt-1"><?php echo e($methodBreakdown['cash']['count']); ?> transactions</p>
            </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p class="text-xl font-bold text-blue-900">₱<?php echo e(number_format($methodBreakdown['gcash']['amount'], 2)); ?></p>
                <p class="text-caption text-blue-700 mt-1"><?php echo e($methodBreakdown['gcash']['count']); ?> transactions</p>
            </div>
            ...
            <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                ...
                <p class="text-xl font-bold text-purple-900">₱<?php echo e(number_format($methodBreakdown['paymaya']['amount'], 2)); ?></p>
                <p class="text-caption text-purple-700 mt-1"><?php echo e($methodBreakdown['paymaya']['count']); ?> transactions</p>
            </div>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p class="text-xl font-bold text-yellow-900">₱<?php echo e(number_format($methodBreakdown['bank_transfer']['amount'], 2)); ?></p>
                <p class="text-caption text-yellow-700 mt-1"><?php echo e($methodBreakdown['bank_transfer']['count']); ?> transactions</p>
            </div>
            ...
            <div class="bg-pink-50 border border-pink-200 rounded-lg p-4">
                ...
                <p class="text-xl font-bold text-pink-900">₱<?php echo e(number_format($methodBreakdown['credit_card']['amount'], 2)); ?></p>
                <p class="text-caption text-pink-700 mt-1"><?php echo e($methodBreakdown['credit_card']['count']); ?> transactions</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="space-y-3">
            <?php $__currentLoopData = $topFacilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facilityName => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-semibold text-gray-900"><?php echo e($facilityName); ?></p>
                        <p class="text-small text-gray-600"><?php echo e($data['bookings']); ?> booking(s)</p>
                    </div>
                </div>
                <div class="text-right">
                    <p class="text-lg font-bold text-lgu-headline">₱<?php echo e(number_format($data['revenue'], 2)); ?></p>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Daily Collections Chart
    const dailyCollections = <?php echo json_encode($dailyCollections, 15, 512) ?>;
    ...
    const methodBreakdown = <?php echo json_encode($methodBreakdown, 15, 512) ?>;
    const methodLabels = [];
    const methodValues = [];
...
<?php echo $__env->make('layouts.treasurer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/treasurer/reports/monthly-summary.blade.php ENDPATH**/ ?>