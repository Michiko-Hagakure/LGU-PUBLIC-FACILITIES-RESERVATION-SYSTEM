...
<?php $__env->startSection('page-title', 'My Statistics'); ?>
<?php $__env->startSection('page-subtitle', 'Your personal performance metrics and activity summary'); ?>
...
<div class="space-y-gr-lg">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-body text-lgu-paragraph">
                Period: <?php echo e($startDate->format('M j, Y')); ?> - <?php echo e($endDate->format('M j, Y')); ?> (Last 30 days)
            </p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gr-md">
        ...
        <div class="bg-white rounded-xl shadow-lg p-gr-lg border-2 border-lgu-green">
            <div class="flex items-center justify-between mb-gr-sm">
                ...
                <span class="text-4xl font-bold text-lgu-headline"><?php echo e($totalVerifications); ?></span>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-gr-lg border-2 border-lgu-green">
            <div class="flex items-center justify-between mb-gr-sm">
                ...
                <span class="text-4xl font-bold text-lgu-headline"><?php echo e($totalApprovals); ?></span>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-gr-lg border-2 border-lgu-tertiary">
            <div class="flex items-center justify-between mb-gr-sm">
                ...
                <span class="text-4xl font-bold text-lgu-headline"><?php echo e($totalRejections); ?></span>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-gr-lg border-2 border-lgu-highlight">
            <div class="flex items-center justify-between mb-gr-sm">
                ...
                <span class="text-4xl font-bold text-lgu-headline"><?php echo e($pendingVerifications); ?></span>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-gr-md">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-gr-lg">
            <div class="flex items-center gap-gr-sm mb-gr-md">
                ...
                <div>
                    ...
                    <p class="text-caption text-gray-600"><?php echo e(\Carbon\Carbon::now()->format('F j, Y')); ?></p>
                </div>
            </div>
            <div class="text-4xl font-bold text-lgu-button"><?php echo e($todayActivity); ?></div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-gr-lg">
            <div class="flex items-center gap-gr-sm mb-gr-md">
                ...
                <div>
                    ...
                    <p class="text-caption text-gray-600">Week <?php echo e(\Carbon\Carbon::now()->weekOfYear); ?></p>
                </div>
            </div>
            <div class="text-4xl font-bold text-blue-600"><?php echo e($weekActivity); ?></div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-gr-lg">
            ...
            <div class="text-4xl font-bold text-purple-600">
                <?php echo e($avgResponseTime && $avgResponseTime->avg_hours ? number_format($avgResponseTime->avg_hours, 1) : '0'); ?>h
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-gr-lg">
        ...
        <div class="flex items-end justify-between gap-gr-sm h-48">
            <?php $__currentLoopData = $activityByDay; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex-1 flex flex-col items-center justify-end h-full">
                    <div class="w-full bg-lgu-button hover:bg-lgu-highlight transition-colors rounded-t-lg flex items-end justify-center text-white font-semibold" 
                         style="height: <?php echo e($day['count'] > 0 ? (($day['count'] / max(array_column($activityByDay, 'count'))) * 100) : 5); ?>%;"
                         title="<?php echo e($day['count']); ?> actions">
                        <?php if($day['count'] > 0): ?>
                            <span class="text-sm mb-2"><?php echo e($day['count']); ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="text-xs text-gray-600 mt-2 font-semibold"><?php echo e($day['day']); ?></div>
                    <div class="text-xs text-gray-400"><?php echo e(\Carbon\Carbon::parse($day['date'])->format('M j')); ?></div>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-gr-md">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-gr-lg">
            ...
            <?php if($topFacilities->count() > 0): ?>
                <div class="space-y-gr-sm">
                    <?php $__currentLoopData = $topFacilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-gr-sm p-gr-sm rounded-lg hover:bg-gray-50 transition-colors">
                            <div class="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center font-bold text-white
                                <?php echo e($index === 0 ? 'bg-gradient-to-br from-yellow-400 to-yellow-500' : ''); ?>

                                <?php echo e($index === 1 ? 'bg-gradient-to-br from-gray-400 to-gray-500' : ''); ?>

                                <?php echo e($index === 2 ? 'bg-gradient-to-br from-orange-400 to-orange-500' : ''); ?>

                                <?php echo e($index > 2 ? 'bg-gradient-to-br from-blue-400 to-blue-500' : ''); ?>">
                                <?php echo e($index + 1); ?>

                            </div>
                            <div class="flex-1 min-w-0">
                                <p class="text-small font-semibold text-gray-900 truncate"><?php echo e($facility->facility_name); ?></p>
                            </div>
                            <div class="flex-shrink-0 bg-lgu-green bg-opacity-10 px-3 py-1 rounded-full">
                                <span class="text-sm font-bold text-lgu-green"><?php echo e($facility->verification_count); ?></span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-gr-lg">
            ...
            <?php if($recentVerifications->count() > 0): ?>
                <div class="space-y-gr-sm max-h-96 overflow-y-auto">
                    <?php $__currentLoopData = $recentVerifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-gr-sm rounded-lg border border-gray-100 hover:border-lgu-button transition-colors">
                            <div class="flex items-start justify-between gap-gr-sm mb-1">
                                ...
                                <span class="text-xs text-gray-500"><?php echo e(\Carbon\Carbon::parse($activity->created_at)->diffForHumans()); ?></span>
                            </div>
                            <p class="text-sm font-semibold text-gray-900"><?php echo e($activity->facility_name); ?></p>
                            <p class="text-xs text-gray-600"><?php echo e($activity->booking_reference); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            <?php else: ?>
...
<?php echo $__env->make('layouts.staff', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/staff/statistics/index.blade.php ENDPATH**/ ?>