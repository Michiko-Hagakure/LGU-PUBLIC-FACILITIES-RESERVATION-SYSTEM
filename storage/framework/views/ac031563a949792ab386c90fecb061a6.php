...
<?php $__env->startSection('title', 'Citizen Analytics - Admin'); ?>
...
<div class="space-y-6 print-area">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 no-print">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-end gap-3">
                <form method="GET" action="<?php echo e(route('admin.analytics.citizen-analytics')); ?>" class="flex flex-wrap items-end gap-3">
                    <div>
                ...
                <div class="relative inline-block" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-10">
                        <a href="<?php echo e(route('admin.analytics.export-citizen-analytics-excel', ['start_date' => $startDate, 'end_date' => $endDate])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-lgu-bg">
                            <i data-lucide="file-spreadsheet" class="w-4 h-4 inline mr-2"></i>
                            Export as Excel
                        </a>
                        <a href="<?php echo e(route('admin.analytics.citizen-analytics.export', ['start_date' => $startDate, 'end_date' => $endDate])); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-lgu-bg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <p class="text-3xl font-bold text-lgu-headline"><?php echo e(number_format($totalCitizens)); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <p class="text-3xl font-bold text-green-600"><?php echo e(number_format($newCitizens)); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <p class="text-3xl font-bold text-purple-600"><?php echo e(number_format($repeatCustomers)); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <p class="text-3xl font-bold text-lgu-headline"><?php echo e(number_format($avgBookingsPerCitizen, 1)); ?></p>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $topCitizens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $citizen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900"><?php echo e($citizen->full_name); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-600"><?php echo e($citizen->email); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <div class="text-sm font-semibold text-lgu-headline"><?php echo e($citizen->total_bookings); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <div class="text-sm font-semibold text-green-600">₱<?php echo e(number_format($citizen->total_spent, 2)); ?></div>
                        </td>
                    </tr>
        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <ul class="list-disc list-inside text-blue-700 space-y-1">
                    <li><?php echo e(number_format(($repeatCustomers / max($totalCitizens, 1)) * 100, 1)); ?>% of citizens are repeat customers</li>
                    <li>Average citizen makes <?php echo e(number_format($avgBookingsPerCitizen, 1)); ?> bookings in the selected period</li>
                    <li><?php echo e(number_format($newCitizens)); ?> new citizens joined during this period</li>
                </ul>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(function() {
        ...
        if (growthContainer) {
            const growthData = <?php echo json_encode($monthlyGrowth, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/admin/analytics/citizen-analytics.blade.php ENDPATH**/ ?>