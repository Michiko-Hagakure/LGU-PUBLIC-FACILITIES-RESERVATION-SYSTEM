...
<?php $__env->startSection('page-title', 'Infrastructure Project Request'); ?>
<?php $__env->startSection('page-subtitle', 'Submit a new infrastructure project request to Infrastructure PM'); ?>
...
<div class="max-w-5xl mx-auto">
    ...
    <form action="<?php echo e(route('admin.infrastructure.project-request.store')); ?>" method="POST" enctype="multipart/form-data" id="projectRequestForm">
        <?php echo csrf_field(); ?>
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select id="requesting_office" name="requesting_office" 
                        ...
                        <option value="Mayor's Office" <?php echo e(old('requesting_office') == "Mayor's Office" ? 'selected' : ''); ?>>Mayor's Office</option>
                        <option value="Vice Mayor's Office" <?php echo e(old('requesting_office') == "Vice Mayor's Office" ? 'selected' : ''); ?>>Vice Mayor's Office</option>
                        <option value="Sangguniang Bayan" <?php echo e(old('requesting_office') == "Sangguniang Bayan" ? 'selected' : ''); ?>>Sangguniang Bayan</option>
                        <option value="Municipal Administrator's Office" <?php echo e(old('requesting_office') == "Municipal Administrator's Office" ? 'selected' : ''); ?>>Municipal Administrator's Office</option>
                        <option value="Municipal Engineering Office" <?php echo e(old('requesting_office') == "Municipal Engineering Office" ? 'selected' : ''); ?>>Municipal Engineering Office</option>
                        <option value="Municipal Planning and Development Office" <?php echo e(old('requesting_office') == "Municipal Planning and Development Office" ? 'selected' : ''); ?>>Municipal Planning and Development Office</option>
                        <option value="Municipal Budget Office" <?php echo e(old('requesting_office') == "Municipal Budget Office" ? 'selected' : ''); ?>>Municipal Budget Office</option>
                        <option value="Municipal Treasurer's Office" <?php echo e(old('requesting_office') == "Municipal Treasurer's Office" ? 'selected' : ''); ?>>Municipal Treasurer's Office</option>
                        <option value="Municipal Assessor's Office" <?php echo e(old('requesting_office') == "Municipal Assessor's Office" ? 'selected' : ''); ?>>Municipal Assessor's Office</option>
                        <option value="Municipal Health Office" <?php echo e(old('requesting_office') == "Municipal Health Office" ? 'selected' : ''); ?>>Municipal Health Office</option>
                        <option value="Municipal Social Welfare and Development Office" <?php echo e(old('requesting_office') == "Municipal Social Welfare and Development Office" ? 'selected' : ''); ?>>Municipal Social Welfare and Development Office</option>
                        <option value="Municipal Agriculture Office" <?php echo e(old('requesting_office') == "Municipal Agriculture Office" ? 'selected' : ''); ?>>Municipal Agriculture Office</option>
                        <option value="Municipal Environment and Natural Resources Office" <?php echo e(old('requesting_office') == "Municipal Environment and Natural Resources Office" ? 'selected' : ''); ?>>Municipal Environment and Natural Resources Office</option>
                        <option value="Municipal Disaster Risk Reduction and Management Office" <?php echo e(old('requesting_office') == "Municipal Disaster Risk Reduction and Management Office" ? 'selected' : ''); ?>>Municipal Disaster Risk Reduction and Management Office</option>
                        <option value="Barangay Office" <?php echo e(old('requesting_office') == "Barangay Office" ? 'selected' : ''); ?>>Barangay Office</option>
                        <option value="Other" <?php echo e(old('requesting_office') == "Other" ? 'selected' : ''); ?>>Other</option>
                    </select>
                    <input type="text" id="requesting_office_other" name="requesting_office_other" 
                        value="<?php echo e(old('requesting_office_other')); ?>" 
                ...
                <div>
                    ...
                    <select id="position" name="position" 
                        ...
                        <option value="Department Head" <?php echo e(old('position') == 'Department Head' ? 'selected' : ''); ?>>Department Head</option>
                        <option value="Division Chief" <?php echo e(old('position') == 'Division Chief' ? 'selected' : ''); ?>>Division Chief</option>
                        <option value="Engineer" <?php echo e(old('position') == 'Engineer' ? 'selected' : ''); ?>>Engineer</option>
                        <option value="Architect" <?php echo e(old('position') == 'Architect' ? 'selected' : ''); ?>>Architect</option>
                        <option value="Accountant" <?php echo e(old('position') == 'Accountant' ? 'selected' : ''); ?>>Accountant</option>
                        <option value="Administrative Officer" <?php echo e(old('position') == 'Administrative Officer' ? 'selected' : ''); ?>>Administrative Officer</option>
                        <option value="Administrative Aide" <?php echo e(old('position') == 'Administrative Aide' ? 'selected' : ''); ?>>Administrative Aide</option>
                        <option value="Secretary" <?php echo e(old('position') == 'Secretary' ? 'selected' : ''); ?>>Secretary</option>
                        <option value="Clerk" <?php echo e(old('position') == 'Clerk' ? 'selected' : ''); ?>>Clerk</option>
                        <option value="Staff" <?php echo e(old('position') == 'Staff' ? 'selected' : ''); ?>>Staff</option>
                        <option value="Barangay Captain" <?php echo e(old('position') == 'Barangay Captain' ? 'selected' : ''); ?>>Barangay Captain</option>
                        <option value="Barangay Councilor" <?php echo e(old('position') == 'Barangay Councilor' ? 'selected' : ''); ?>>Barangay Councilor</option>
                        <option value="Barangay Secretary" <?php echo e(old('position') == 'Barangay Secretary' ? 'selected' : ''); ?>>Barangay Secretary</option>
                        <option value="Barangay Treasurer" <?php echo e(old('position') == 'Barangay Treasurer' ? 'selected' : ''); ?>>Barangay Treasurer</option>
                    ...
                    <input type="text" id="position_other" name="position_other" 
                        value="<?php echo e(old('position_other')); ?>" 
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lgu-highlight focus:border-lgu-highlight transition-colors mt-2 hidden"
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="project_title" name="project_title" 
                            value="<?php echo e(old('project_title')); ?>" 
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lgu-highlight focus:border-lgu-highlight transition-colors"
                    ...
                    <div>
                        ...
                        <select id="project_category" name="project_category" 
                            ...
                            <option value="<?php echo e($category); ?>" <?php echo e(old('project_category') == $category ? 'selected' : ''); ?>>
                                <?php echo e($category); ?>

                            </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <option value="Other" <?php echo e(old('project_category') == 'Other' ? 'selected' : ''); ?>>Other</option>
                        </select>
                        <input type="text" id="project_category_other" name="project_category_other" 
                            value="<?php echo e(old('project_category_other')); ?>" 
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lgu-highlight focus:border-lgu-highlight transition-colors mt-2 hidden"
                    ...
                    <div>
                        ...
                        <select id="priority_level" name="priority_level" 
                            ...
                            <?php $__currentLoopData = $priorityLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($level['value']); ?>" <?php echo e(old('priority_level') == $level['value'] ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <textarea id="problem_identified" name="problem_identified" rows="4" 
                        ...
                        placeholder="Describe the problem or need that this project aims to address..." required><?php echo e(old('problem_identified')); ?></textarea>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" id="scope_item1" name="scope_item1" 
                                value="<?php echo e(old('scope_item1')); ?>" 
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lgu-highlight focus:border-lgu-highlight transition-colors"
                        ...
                        <div>
                            ...
                            <input type="text" id="scope_item2" name="scope_item2" 
                                value="<?php echo e(old('scope_item2')); ?>" 
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lgu-highlight focus:border-lgu-highlight transition-colors"
                        ...
                        <div>
                            ...
                            <input type="text" id="scope_item3" name="scope_item3" 
                                value="<?php echo e(old('scope_item3')); ?>" 
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lgu-highlight focus:border-lgu-highlight transition-colors"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6 overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="project_location" name="project_location" 
                            value="<?php echo e(old('project_location')); ?>" 
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lgu-highlight focus:border-lgu-highlight transition-colors"
                ...
                <div>
                    ...
                    <input type="hidden" id="requested_start_date" name="requested_start_date" value="<?php echo e(old('requested_start_date')); ?>">
                    <input type="text" id="requested_start_date_display" 
                        value="<?php echo e(old('requested_start_date') ? date('F d, Y', strtotime(old('requested_start_date'))) : ''); ?>" 
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="prepared_by" name="prepared_by" 
                        value="<?php echo e(session('user_name')); ?>" 
                ...
                <div>
                    ...
                    <input type="text" id="prepared_position" name="prepared_position" 
                        value="<?php echo e(session('user_role', 'Staff')); ?>" 
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 text-gray-700"
                        readonly>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const defaultLat = <?php echo e(old('latitude') ?: '14.5995'); ?>;
    const defaultLng = <?php echo e(old('longitude') ?: '120.9842'); ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/admin/infrastructure/project-request.blade.php ENDPATH**/ ?>