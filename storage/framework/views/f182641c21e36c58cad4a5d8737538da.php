...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert2/11.14.5/sweetalert2.min.css" rel="stylesheet">
    ...
    <section class="background-radial-gradient overflow-hidden">
        <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
                ...
                <script>
                    window.addEventListener('DOMContentLoaded', function() {
                        Swal.fire({
                            icon: 'success',
                            title: 'Success',
                            text: '<?php echo e(session('success_message')); ?>',
                            confirmButtonColor: '#faae2b',
                        });
                    });
                </script>
            ...
            <form method="POST">
                <?php echo csrf_field(); ?>
                <!-- Step 1: Enter Email -->
                <div class="step <?php echo e((session('step') ?? 1) === 1 ? 'active' : ''); ?>">
                ...
                <!-- Step 2: Verify OTP -->
                <div class="step <?php echo e((session('step') ?? 1) === 2 ? 'active' : ''); ?>">
                ...
                <!-- Step 3: New Password -->
                <div class="step <?php echo e((session('step') ?? 1) === 3 ? 'active' : ''); ?>">
                ...
                <!-- Step 4: Success -->
                <div class="step <?php echo e((session('step') ?? 1) === 4 ? 'active' : ''); ?>">
            ...
            <?php if((session('step') ?? 1) < 4): ?>
            <div class="text-center mt-3">
                <a href="<?php echo e(route('login')); ?>" style="color: var(--headline); text-decoration: none;">
...
<?php /**PATH C:\laragon\www\local-government-unit-1-ph.com\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>