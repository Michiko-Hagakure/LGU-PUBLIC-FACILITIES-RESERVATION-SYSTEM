...
<?php $__env->startSection('title', 'Daily Collections Report'); ?>
<?php $__env->startSection('page-title', 'Daily Collections Report'); ?>
...
<div class="space-y-gr-lg">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="GET" action="<?php echo e(route('treasurer.reports.daily-collections')); ?>" class="flex flex-col md:flex-row items-end gap-4">
            <div class="flex-1">
            ...
            <a href="<?php echo e(route('treasurer.reports.daily-collections.export', ['date' => $selectedDate->format('Y-m-d')])); ?>" 
    ...
    <div class="text-center">
        <h2 class="text-h3 font-bold text-lgu-headline"><?php echo e($selectedDate->format('F d, Y')); ?></h2>
        <p class="text-small text-gray-600 mt-gr-xs"><?php echo e($selectedDate->format('l')); ?></p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gr-md">
        ...
        <div class="bg-green-500 rounded-xl shadow-lg p-6 text-white">
            ...
            <p class="text-2xl font-bold">₱<?php echo e(number_format($stats['total_collections'], 2)); ?></p>
        </div>
        ...
        <div class="bg-blue-500 rounded-xl shadow-lg p-6 text-white">
            ...
            <p class="text-2xl font-bold"><?php echo e($stats['total_transactions']); ?></p>
        </div>
        ...
        <div class="bg-purple-500 rounded-xl shadow-lg p-6 text-white">
            ...
            <p class="text-2xl font-bold">
                ₱<?php echo e($stats['total_transactions'] > 0 ? number_format($stats['total_collections'] / $stats['total_transactions'], 2) : '0.00'); ?>
        ...
        <div class="bg-orange-500 rounded-xl shadow-lg p-6 text-white">
            ...
            <p class="text-2xl font-bold">₱<?php echo e(number_format($stats['cash'], 2)); ?></p>
            <p class="text-caption opacity-75 mt-1"><?php echo e($stats['cash_count']); ?> transaction(s)</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-gr-sm">
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <p class="text-xl font-bold text-green-900">₱<?php echo e(number_format($stats['cash'], 2)); ?></p>
                <p class="text-caption text-green-700 mt-1"><?php echo e($stats['cash_count']); ?> transaction(s)</p>
            </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p class="text-xl font-bold text-blue-900">₱<?php echo e(number_format($stats['gcash'], 2)); ?></p>
                <p class="text-caption text-blue-700 mt-1"><?php echo e($stats['gcash_count']); ?> transaction(s)</p>
            </div>
            ...
            <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                ...
                <p class="text-xl font-bold text-purple-900">₱<?php echo e(number_format($stats['paymaya'], 2)); ?></p>
                <p class="text-caption text-purple-700 mt-1"><?php echo e($stats['paymaya_count']); ?> transaction(s)</p>
            </div>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p class="text-xl font-bold text-yellow-900">₱<?php echo e(number_format($stats['bank_transfer'], 2)); ?></p>
                <p class="text-caption text-yellow-700 mt-1"><?php echo e($stats['bank_transfer_count']); ?> transaction(s)</p>
            </div>
            ...
            <div class="bg-pink-50 border border-pink-200 rounded-lg p-4">
                ...
                <p class="text-xl font-bold text-pink-900">₱<?php echo e(number_format($stats['credit_card'], 2)); ?></p>
                <p class="text-caption text-pink-700 mt-1"><?php echo e($stats['credit_card_count']); ?> transaction(s)</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-body font-bold text-lgu-headline flex items-center">
                ...
                All Transactions (<?php echo e($payments->count()); ?>)
            </h3>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap text-small text-gray-900">
                            <?php echo e(\Carbon\Carbon::parse($payment->paid_at)->format('h:i A')); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-small font-semibold text-green-600"><?php echo e($payment->transaction_reference); ?></span>
                        </td>
                        <td class="px-6 py-4">
                            <p class="text-small font-medium text-gray-900"><?php echo e($payment->applicant_name); ?></p>
                        </td>
                        <td class="px-6 py-4">
                            <p class="text-small text-gray-900"><?php echo e($payment->facility_name); ?></p>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <?php
                                $methodColors = [
                            ...
                            ?>
                            <span class="px-2 py-1 rounded-full text-caption font-semibold <?php echo e($colorClass); ?>">
                                <?php echo e(ucfirst(str_replace('_', ' ', $payment->payment_method))); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <span class="text-small font-bold text-lgu-headline">₱<?php echo e(number_format($payment->amount_due, 2)); ?></span>
                        </td>
                    </tr>
                ...
                <tfoot class="bg-gray-50 border-t-2 border-gray-300">
                    <tr>
                        ...
                        <td class="px-6 py-4 text-right">
                            <span class="text-body font-bold text-green-600">₱<?php echo e(number_format($stats['total_collections'], 2)); ?></span>
                        </td>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="p-12 text-center">
            ...
            <p class="text-small text-gray-500">No payments were collected on <?php echo e($selectedDate->format('F d, Y')); ?>.</p>
        </div>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.treasurer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/treasurer/reports/daily-collections.blade.php ENDPATH**/ ?>