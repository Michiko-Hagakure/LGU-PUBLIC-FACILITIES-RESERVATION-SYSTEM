...
<?php $__env->startSection('page-subtitle', 'Track and manage your facility bookings'); ?>
...
<div class="space-y-6">
        ...
        <div class="space-y-6">
            ...
            <div>
                <div class="flex items-center justify-between mb-3">
                    ...
                    <a href="<?php echo e(URL::signedRoute('citizen.reservation.history')); ?>" 
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="<?php echo e(URL::signedRoute('citizen.reservations', ['status' => 'all', 'search' => $search])); ?>" 
                       class="px-5 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-sm hover:shadow-md cursor-pointer <?php echo e($status === 'all' ? 'bg-lgu-button text-lgu-button-text shadow-lg scale-105' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                        ...
                        All <span class="ml-1 px-2 py-0.5 bg-white/30 rounded-full text-xs"><?php echo e($statusCounts['all']); ?></span>
                    </a>
                    <a href="<?php echo e(URL::signedRoute('citizen.reservations', ['status' => 'active', 'search' => $search])); ?>" 
                       class="px-5 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-sm hover:shadow-md cursor-pointer <?php echo e($status === 'active' ? 'bg-lgu-button text-lgu-button-text shadow-lg scale-105' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="inline-block mr-1">
                            <path d="M22 12h-4l-3 9L9 3l-3 9H2"/>
                        </svg>
                        Active <span class="ml-1 px-2 py-0.5 bg-white/30 rounded-full text-xs"><?php echo e($statusCounts['active']); ?></span>
                    </a>
                    <a href="<?php echo e(URL::signedRoute('citizen.reservations', ['status' => 'completed', 'search' => $search])); ?>" 
                       class="px-5 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-sm hover:shadow-md cursor-pointer <?php echo e($status === 'completed' ? 'bg-lgu-button text-lgu-button-text shadow-lg scale-105' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="inline-block mr-1">
    ...
    <?php if($bookings->isEmpty()): ?>
        <div class="bg-white shadow-xl rounded-2xl p-16 text-center border border-gray-100">
            ...
            <p class="text-gray-600 mb-8 max-w-md mx-auto">You haven't made any bookings yet<?php echo e($search ? ' matching your search' : ''); ?>. Start by browsing our available facilities!</p>
            <a href="<?php echo e(URL::signedRoute('citizen.browse-facilities')); ?>" 
                    ...
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="md:w-96 h-64 md:h-auto bg-gray-200 flex-shrink-0 relative group">
                            <?php if($booking->facility_image): ?>
                                <img src="<?php echo e(url('/files/' . $booking->facility_image)); ?>" 
                        ...
                        <div class="flex-1 p-6">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex-1">
                                    <div class="flex items-center gap-3 mb-2 flex-wrap">
                                        <h3 class="text-xl font-bold text-gray-900"><?php echo e($booking->facility_name); ?></h3>
                                    ...
                                    <p class="text-sm text-gray-600 mb-1">
                                        ...
                                        <span class="font-bold text-lgu-headline">BK<?php echo e(str_pad($booking->id, 6, '0', STR_PAD_LEFT)); ?></span>
                                    </p>
                                    <p class="text-sm text-gray-700">
                                        <span class="font-medium">Purpose:</span> <?php echo e($booking->purpose); ?>

                                    </p>
                                </div>

                                <!-- Status Badge -->
                                <span class="px-4 py-2 rounded-full text-sm font-bold <?php echo e($statusBadge['bg']); ?> <?php echo e($statusBadge['text']); ?> border-2 <?php echo e($statusBadge['border']); ?> whitespace-nowrap shadow-sm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5 p-4 bg-gray-50 rounded-lg">
                                <div class="flex items-center text-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-gray-900"><?php echo e($startTime->format('M d, Y')); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-center text-sm">
                                    <div class="w-10 h-10 bg-lgu-button/10 rounded-lg flex items-center justify-center mr-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-gray-900"><?php echo e($startTime->format('g:i A')); ?> - <?php echo e(\Carbon\Carbon::parse($booking->end_time)->format('g:i A')); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-center text-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-green-600 text-lg">₱<?php echo e(number_format($booking->total_amount, 2)); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 flex-wrap">
                                <a href="<?php echo e(URL::signedRoute('citizen.reservations.show', $booking->id)); ?>" 
                                ...
                                <?php if($booking->status === 'payment_pending'): ?>
                                    <a href="<?php echo e(URL::signedRoute('citizen.payment-slips')); ?>" 
...
function liveSearch(query) {
    ...
    searchTimeout = setTimeout(() => {
        ...
        window.location.href = `<?php echo e(URL::signedRoute('citizen.reservations')); ?>?status=${currentStatus}&search=${encodeURIComponent(query)}`;
    }, 500);
}
...
let lastBookingData = <?php echo json_encode($bookings->items(), 15, 512) ?>;
...
function refreshData() {
    fetch('<?php echo e(route("citizen.reservations.json")); ?>' + window.location.search)
        .then(res => res.json())
        .then(data => {
...
<?php echo $__env->make('layouts.citizen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\local-government-unit-1-ph.com\resources\views/citizen/reservations/index.blade.php ENDPATH**/ ?>