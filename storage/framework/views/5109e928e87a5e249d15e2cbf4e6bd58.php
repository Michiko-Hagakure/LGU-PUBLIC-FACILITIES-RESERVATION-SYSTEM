...
<?php $__env->startSection('page-subtitle', 'View booking schedule and check for conflicts'); ?>
            ...
            <div class="flex-1 min-w-[200px]">
                ...
                <select id="facility-filter" 
                    ...
                    <?php $__currentLoopData = $facilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($facility->facility_id); ?>"><?php echo e($facility->name); ?></option>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: function(info, successCallback, failureCallback) {
            ...
            const url = `<?php echo e(route('staff.calendar.events')); ?>?facility_id=${facilityId}&status=${status}&start=${info.startStr}&end=${info.endStr}`;
...
<?php echo $__env->make('layouts.staff', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/staff/calendar/index.blade.php ENDPATH**/ ?>