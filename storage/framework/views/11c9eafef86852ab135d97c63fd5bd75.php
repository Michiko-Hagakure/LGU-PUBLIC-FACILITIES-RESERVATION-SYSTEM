...
<?php $__env->startSection('page-title', 'Admin Calendar'); ?>
<?php $__env->startSection('page-subtitle', 'View all bookings and schedules'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: function(info, successCallback, failureCallback) {
            ...
            fetch(`<?php echo e(route('admin.calendar.events')); ?>?${params.toString()}`)
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/admin/calendar/index.blade.php ENDPATH**/ ?>