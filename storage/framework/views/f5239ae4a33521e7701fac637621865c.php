    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-md p-6">
                <form action="<?php echo e(route('citizen.contact.store')); ?>" method="POST" enctype="multipart/form-data" id="contactForm">
                    <?php echo csrf_field(); ?>

                    <!-- Name -->
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Full Name *</label>
                        <input type="text" name="name" id="name" value="<?php echo e(old('name', session('user_name'))); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="category" id="category" required onchange="updateSubjectOptions()"
                            ...
                            <option value="booking_issue" <?php echo e(old('category') == 'booking_issue' ? 'selected' : ''); ?>>Booking Issue</option>
                            <option value="payment_issue" <?php echo e(old('category') == 'payment_issue' ? 'selected' : ''); ?>>Payment Issue</option>
                            <option value="technical_issue" <?php echo e(old('category') == 'technical_issue' ? 'selected' : ''); ?>>Technical Issue</option>
                            <option value="complaint" <?php echo e(old('category') == 'complaint' ? 'selected' : ''); ?>>Complaint</option>
                            <option value="suggestion" <?php echo e(old('category') == 'suggestion' ? 'selected' : ''); ?>>Suggestion</option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4 hidden" id="customSubjectContainer">
                        ...
                        <input type="text" name="custom_subject" id="custom_subject" value="<?php echo e(old('custom_subject')); ?>"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="message" id="message" rows="6" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"><?php echo e(old('message')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-blue-50 rounded-lg p-6 mb-6">
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="<?php echo e(route('citizen.help-center.index')); ?>" class="text-blue-600 hover:text-blue-800 flex items-center">
                    ...
                    <li>
                        <a href="<?php echo e(route('citizen.contact.my-inquiries')); ?>" class="text-blue-600 hover:text-blue-800 flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                            My Inquiries
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (category) {
        ...
        <?php if(old('subject')): ?>
        document.getElementById('subject').value = '<?php echo e(old('subject')); ?>';
        toggleCustomSubject();
        <?php endif; ?>
    }
});
...
<?php echo $__env->make('layouts.citizen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/citizen/contact/index.blade.php ENDPATH**/ ?>