...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="<?php echo e(route('citizen.dashboard')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.dashboard') ? 'active' : ''); ?>">
...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="<?php echo e(route('citizen.browse-facilities')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.browse-facilities') ? 'active' : ''); ?>">
                <i data-lucide="calendar-plus" class="w-5 h-5 mr-gr-xs flex-shrink-0"></i>
                <span>Book Facility</span>
            </a>
        </li>
        <li>
            <a href="<?php echo e(route('citizen.reservations')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.reservations') ? 'active' : ''); ?>">
                <i data-lucide="calendar-check" class="w-5 h-5 mr-gr-xs flex-shrink-0"></i>
                <span>My Reservations</span>
            </a>
        </li>
        <li>
            <a href="<?php echo e(route('citizen.reservation.history')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.reservation.history') ? 'active' : ''); ?>">
...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="<?php echo e(route('citizen.facility-calendar')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.facility-calendar') ? 'active' : ''); ?>">
                <i data-lucide="calendar-days" class="w-5 h-5 mr-gr-xs flex-shrink-0"></i>
                <span>Availability Calendar</span>
            </a>
        </li>
        <li>
            <a href="<?php echo e(route('citizen.reviews.index')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.reviews.*') ? 'active' : ''); ?>">
...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="<?php echo e(route('citizen.payment-slips')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.payment-slips') ? 'active' : ''); ?>">
                <i data-lucide="file-text" class="w-5 h-5 mr-gr-xs flex-shrink-0"></i>
                <span>Payment Slips</span>
            </a>
        </li>
        <li>
            <a href="<?php echo e(route('citizen.payment-methods.index')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.payment-methods.*') ? 'active' : ''); ?>">
                <i data-lucide="credit-card" class="w-5 h-5 mr-gr-xs flex-shrink-0"></i>
                <span>Payment Methods</span>
            </a>
        </li>
        <li>
            <a href="<?php echo e(route('citizen.transactions.index')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.transactions.*') ? 'active' : ''); ?>">
...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="<?php echo e(route('citizen.bulletin')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.bulletin') ? 'active' : ''); ?>">
...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="<?php echo e(route('citizen.profile')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.profile') ? 'active' : ''); ?>">
                <i data-lucide="user-circle" class="w-5 h-5 mr-gr-xs flex-shrink-0"></i>
                <span>Profile Settings</span>
            </a>
        </li>
        <li>
            <a href="<?php echo e(route('citizen.security')); ?>" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 <?php echo e(request()->routeIs('citizen.security*') ? 'active' : ''); ?>">
...
<?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/components/sidebar/citizen-menu.blade.php ENDPATH**/ ?>