...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center gap-3">
            <form action="<?php echo e(route('admin.infrastructure.projects.sync-all')); ?>" method="POST" class="inline">
                <?php echo csrf_field(); ?>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <a href="<?php echo e(route('admin.infrastructure.projects.show', $request->id)); ?>" class="px-3 py-1.5 bg-lgu-highlight text-white text-xs font-medium rounded-lg hover:bg-lgu-stroke transition-colors">
                                    View
                                </a>
                                <?php if($request->external_project_id): ?>
                                <span class="text-xs font-mono text-gray-500">#<?php echo e($request->external_project_id); ?></span>
                                <?php endif; ?>
                            </div>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/admin/infrastructure/index.blade.php ENDPATH**/ ?>