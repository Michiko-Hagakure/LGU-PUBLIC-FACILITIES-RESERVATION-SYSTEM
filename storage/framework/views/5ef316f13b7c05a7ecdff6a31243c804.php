...
<div class="space-y-gr-lg">
    ...
    function shareFavorites() {
        const facilityIds = <?php echo json_encode($favorites->pluck('facility_id')->toArray(), 15, 512) ?>;
        const shareUrl = `<?php echo e(route('citizen.browse-facilities')); ?>?favorites=${facilityIds.join(',')}`;
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <div class="relative h-48 bg-gray-200">
                            ...
                            <div class="absolute top-3 right-3 flex gap-2">
                                <button onclick="openNotificationSettings(<?php echo e($facility->facility_id); ?>, <?php echo e(json_encode($facility->pivot ?? new stdClass())); ?>)" 
...
<?php echo $__env->make('layouts.citizen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/citizen/favorites/index.blade.php ENDPATH**/ ?>