...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <a href="<?php echo e(URL::signedRoute('citizen.browse-facilities')); ?>" class="inline-flex items-center px-6 py-3 bg-lgu-button text-lgu-button-text font-semibold rounded-lg hover:bg-lgu-highlight transition shadow-md">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <a href="<?php echo e(URL::signedRoute('citizen.facility-calendar')); ?>" class="inline-flex items-center px-6 py-3 bg-lgu-button text-lgu-button-text font-semibold rounded-lg hover:bg-lgu-highlight transition shadow-md">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(URL::signedRoute('citizen.reservations')); ?>" class="text-sm text-lgu-button hover:text-lgu-highlight font-medium">View All</a>
            </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(URL::signedRoute('citizen.payment-slips')); ?>" class="text-sm text-lgu-button hover:text-lgu-highlight font-medium">View All</a>
            </div>
                ...
                <div class="space-y-3">
                    <?php $__currentLoopData = $pendingPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between p-3 border border-yellow-200 bg-yellow-50 rounded-lg">
                            ...
                            <a href="<?php echo e(URL::signedRoute('citizen.payment-slips.show', $payment->id)); ?>" class="text-yellow-600 hover:text-yellow-800 text-sm font-medium">
                                Pay Now
                            </a>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
